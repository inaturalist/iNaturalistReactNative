 ...
 */
 ...
 } = require( "./generate-iOS-localizables" );
 const fs = require( "fs" );
 ...
 const argv = yargs
   .usage(
     "Take translations output, and write individual Localizable.strings files for each " +
       "locale:  es.lproj/Localizable.strings => {<hash> = '\'translatedString'\'}",
   )
   ...
   .describe(
     args.IOS_RES_DIR,
     "path to the res folder of your ios application",
   )
