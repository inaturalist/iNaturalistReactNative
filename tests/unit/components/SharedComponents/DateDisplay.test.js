...
describe( "DateDisplay", () => {
  ...
  it( "should format correctly", () => {
    renderComponent( <DateDisplay dateString="2023-12-14T21:37:00+00:00" /> );
    expect( screen.getByText( "12/14/23 9:37 PM" ) ).toBeTruthy( );
  } );

  it( "should show the date in the local time zone by default", () => {
    renderComponent( <DateDisplay dateString="2023-01-02T08:00:00+01:00" /> );
  ...
  it( "should display placeholder if no dateString", () => {
    renderComponent( <DateDisplay dateString={undefined} /> );
