  ...
  apps: {
    "ios.debug": {
      ...
      build:
        ...
        "xcodebuild -workspace ios/iNaturalistReactNative.xcworkspace -scheme iNaturalistReactNative -configuration Debug -sdk iphonesimulator -arch arm64 -derivedDataPath ios/build ONLY_ACTIVE_ARCH=YES EXCLUDED_ARCHS=x86_64",
    },
    "ios.release": {
      type: "ios.app",
      binaryPath:
      ...
      build:
        /* eslint-disable-next-line max-len */
        "xcodebuild -workspace ios/iNaturalistReactNative.xcworkspace -scheme iNaturalistReactNative -configuration Release -sdk iphonesimulator -arch arm64 -derivedDataPath ios/build ONLY_ACTIVE_ARCH=YES EXCLUDED_ARCHS=x86_64",
    },
    "android.debug": {
      type: "android.apk",
