...
const fetchUserMe = async ( params: any = {}, opts: any = {} ): Promise<any> => {
  try {
...
const fetchMemberProjects = async ( params: any = {}, opts: any = {} ): Promise<any> => {
  try {
...
const updateUsers = async ( params: any = {}, opts: any = {} ): Promise<any> => {
  try {
