...
class Observation extends Realm.Object {
  ...
  static schema = {
    ...
    properties: {
      ...
      place_guess: { type: "string", optional: true, mapTo: "placeGuess" },
      positional_accuracy: "double?",
      quality_grade: { type: "string", optional: true, mapTo: "qualityGrade" },
      taxon: "Taxon?",
      // datetime when the observer observed the organism; user-editable, but
      // only by changing observed_on_string
      time_observed_at: { type: "string", optional: true, mapTo: "timeObservedAt" },
      user: "User?",
      updated_at: "date?",
