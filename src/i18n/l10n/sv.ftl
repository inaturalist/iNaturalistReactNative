...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-library = iNaturalist kan spara bilder du tar i appen till din enhets bibliotek.
...
Save-photos-to-your-library = Spara bilder till ditt bibliotek
...
There-was-an-error-that-might-be-fixed-by-logging-in-again = Det uppstod ett fel som kanske kan åtgärdas genom att logga in igen.
