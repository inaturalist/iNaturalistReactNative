...
ALL = ALLA
All = Alla
All-observation-options = Alla fyndalternativ (inklusive iNaturalist AI-kamera, standardkamera, uppladdning från bildbibliotek och ljudinspelning)
All-observations = Alla fynd
All-observations-submitted-to-iNaturalist-need-a-date-and-location = Alla fynd som skickas in till iNaturalist behöver ett datum och en plats för att vara användbar för forskare. Vänligen uppdatera fynd om de behöver mer information.
...
CONFIRM = BEKRÄFTA
Congrats-on-making-your-first-observation = Grattis till ditt första rapporterade fynd!
...
Get-identifications-from-real-people = Få artbestämningar av riktiga människor.
...
Grow-your-collection = Utöka din samling
HELP = HJÄLP
Hide = Dölj
Highest = Högsta
HIGHEST-RANK = HÖGSTA RANG
How-does-it-feel-to-identify = Hur känns det att artbestämma och knyta an till naturen runt omkring dig?
...
If-you-took-the-original-photo-you-can-help = Om du tog den ursprungliga bilden av organismen kan du hjälpa till att träna iNaturalist att bestämma denna art genom att spara och ladda upp den till iNaturalist, där communityn kan hjälpa till att bestämma den.
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist kan spara bilder som du tar i appen till din enhets galleri.
INATURALIST-COMMUNITY = INATURALIST-COMMUNITYN
iNaturalist-couldnt-identify-this-organism = iNaturalist kunde inte bestämma denna organism.
...
Once-youve-uploaded-to-iNaturalist = När du väl har laddat upp till iNaturalist, kan andra naturforskare i vår community hjälpa till att bekräfta dina bestämningar. Håll ett öga på dina aviseringar för uppdateringar!
Open = Öppen
...
Other = Annat
OTHER-DATA = MER DATA
Other-members-of-our-community-can-verify = Andra medlemmar i vår community kan verifiera och bestämma dina fynd om du laddar upp dem till iNaturalist.
...
Save-photos-to-your-photo-library = Spara bilder till ditt galleri
...
Scientists-use-citizen-science-data = Vetenskapsmän använder medborgarforskningsdata precis som dina för att bättre förstå arter runtom hela världen.
SEARCH = SÖK
Search = Sök
...
Use-iNaturalist-to-collect-any-kind-of = Använd iNaturalist för att samla alla typer av växter, insekter, spindlar, fåglar eller andra djur och lägga till dem till dina fynd!
...
Weve-made-some-updates = Vi har gjort några uppdateringar, så vi rekommenderar att du tar en titt på dina inställningar. Du kan alltid uppdatera dessa senare.
...
You-make-an-observation-every-time-you = Du gör ett fynd varje gång du tar en bild av en organism med ett datum och plats.
...
Your-observations-can-help-scientists = Dina fynd kan hjälpa forskare!
Your-observations-can-now-help-scientists = Dina fynd kan nu hjälpa forskare.
...
Youve-made-2-observations = Du har gjort 2 fynd!
