...
A-global-community-for-nature = En global community för naturen
ABOUT = OM
...
ADVANCED-SETTINGS = AVANCERAD INSTÄLLNINGAR
Affiliation = Anknytning: { $site }
After-capturing-or-importing-photos-show = Efter att ha tagit eller importerat bilder, visa:
Agree = Håller med
AGREE = GODKÄNN
...
ALL = ALLA
All = Alla
All-observation-options--list = Alla fyndalternativ: iNaturalist AI-kamera, standardkamera, uppladdning från bildbibliotek och ljudinspelare
All-observations = Alla fynd
All-observations-need-a-date-and-location-to-be-used-for-science = Alla fynd behöver ett datum och en plats för vetenskaplig användning. Vänligen uppdatera fynd om de behöver mer information.
...
Already-have-an-iNaturalist-account = Har du redan ett iNaturalist-konto?
Amphibians = Amphibians
An-Internet-connection-is-required = En internetanslutning krävs för att läsa in fler observationer.
Analyzing-for-the-best-identification = Analyserar för bästa identifiering...
Any--date = Vilket som
...
Change-end-date = Ändra slutdatum
Change-observations-sort-order = Ändra sorteringsordning för fynd
Change-project = Ändra projekt
Change-species-sort-order = Ändra sorteringsordning för arter
...
CONFIRM = BEKRÄFTA
Congratulations-You-made-your-first-observation = Grattis! Du gjorde ditt första fynd!
Connect-with-expert-naturalists = Få kontakt med kunniga amatörbiologer
...
Content-Hidden = Innehållet är dolt
CONTINUE = FORTSÄTT
...
Create-observation-with-no-evidence = Skapa ett fynd utan belägg
DATA-QUALITY = DATAKVALITET
DATA-QUALITY-ASSESSMENT = DATAKVALITETSBEDÖMNING
Data-Quality-Assessment = Bedömning av datakvalitet
...
Date-uploaded-on-header-short = Uppladdad den:
...
datetime-format-long-with-zone = yyyy-MM-dd, HH:mm (zzz)
...
Disable-location = Inaktivera platstjänst
...
DISCOVER-NATURE-AROUND-YOU = UPPTÄCK NATUREN RUNT OMKRING DIG
Dismiss-announcement = Avfärda tillkännagivandet
Do-you-know-what-group-this-is-in = Vet du vilken grupp detta är i?
DONATE = DONERA
DONATE-TO-INATURALIST = DONERA TILL INATURALIST
DONE = KLART
Dont-have-an-account = <0>Har du inget konto? </0><1>Registrera dig</1>
...
Enable-location = Aktivera platstjänst
...
Experts-help-verify-and-improve-IDs = Experter hjälper till att bekräfta och förbättra bestämningar
Explore = Utforska
EXPLORE = UTFORSKA
...
Get-an-instant-ID-of-any-plant-animal-fungus = Få en omedelbar bestämning av någon växt, svamp eller ett djur
Get-feedback-from-naturalists-and-experts-who-will-help-verify = Få återkoppling från amatörbiologer och experter som hjälper dig verifiera och förbättra dina artbestämningar.
...
Go-back = Gå tillbaka
Google-Play-Services-Not-Installed = Google Play-tjänster är inte installerade
...
HELP = HJÄLP
Help-create-Research-Grade-data-used-in-science-and-conservation = Hjälp till att skapa data av forskningsklass som används inom vetenskap och naturvård.
Help-protect-species = Hjälp till att skydda arter
Help-us-translate-the-app = Hjälp oss att översätta den här appen!
Hide = Dölj
Highest = Högsta
HIGHEST-RANK = HÖGSTA RANG
I-agree-to-the-Terms-of-Use = <0>Jag godkänner Användarvillkoren och Integritetspolicyn, och jag har granskat Community-riktlinjerna (</0><1>obligatoriskt</1><0>).</0>
Iconic-taxon-name = Organismgrupp: { $iconicTaxon }
ID-in-Camera = Artbestämning i kameran
ID-Suggestions = Bestämningsförslag
...
IDENTIFY = ARTBESTÄM
Identify-organisms-in-real-time-with-your-camera = Bestäm organismer i realtid med din kamera
...
If-you-save-this-observation-and-upload-it-to-iNaturalist = Om du sparar detta fynd och laddar upp det till iNaturalist kan andra personer kanske hjälpa till med artbestämningen.
...
Improve-suggestions-by-using-your-location = Förbättra förslagen med hjälp av din plats
...
iNaturalist-can-use-your-location-to-give-you-better-identification-suggestions = iNaturalist kan använda din plats för att ge dig bättre bestämningsförslag. Vi använder den också för att hjälpa dig att hitta arter sedda i närheten. Att dela din plats gör det lättare att skapa användbara data för vetenskapen.
...
iNaturalists-apps-are-designed-and-developed-3 = iNaturalists appar designas, utvecklas och stöds av iNaturalist-teamet: Yaron Budowski, Amanda Bullington, Tony Iwane, Johannes Klein, Patrick Leary, Joanne Lin, Scott Loarie, Abhas Misraraj, Sylvain Morin, Carrie Seltzer, Alex Shepard, Thea Skaff, Angie Ta, Ken-ichi Ueda, Kirk van Gorkom, Jason Walthall & Jane Weeden.
...
It-might-be-one-of-these = Det skulle kunna vara en av dessa
January = Januari
JOIN = GÅ MED
Join-a-global-community-for-nature = Gå med i en global community för naturen
...
Learn-from-people-who-verify-and-refine-your-identifications = Lär dig av andra som verifierar och förbättrar dina artbestämningar.
Learn-More = Läs mer
LEARN-MORE-ABOUT-THIS-GROUP = LÄS MER OM DENNA GRUPP
LEARN-MORE-ABOUT-THIS-SPECIES = LÄS MER OM DENNA ART
Least-Observed = Minst observerade
LEAVE = LÄMNA
...
Most-faved = Mest populära
Most-Observed-Default = Mest observerade (standard)
MY-CONTENT--notifications = MITT INNEHÅLL
My-Observations = Mina fynd
My-Observations--bottom-tab = Mina fynd
Native = Inhemsk
...
Observation-Copyright = Upphovsrätt för fyndet: ©️ { $userName } · { $restrictions }
Observation-has-no-photos-and-no-sounds = Detta fynd har inga bilder och inga ljud.
Observation-location-obscured-randomized-point = Detta fynds position är diffuserad. Du ser en slumpartad punkt inom diffuseringspolygonen.
Observation-location-obscured-you-can-see-your-own = Detta fynds position är diffuserad. Du kan alltid se positionen för dina egna fynd.
Observation-location-obscured-you-have-permission = Detta fynds position är diffuserad. Du har behörighet att se denna position.
...
OBSERVED-AT--label = OBSERVERAD KL
OBSERVED-IN--label = OBSERVERAD PÅ
...
Offline-suggestions-may-differ-from-online = Offline-förslag kan skilja sig från online-förslag, och taxonbilder och vardagliga namn kanske inte laddas.
OK = OK
...
Opens-search-interface = Öppnar sökgränssnittet.
...
Point-the-camera-at-an-animal-plant-or-fungus = Rikta kameran mot ett djur, en växt eller en svamp
...
Press-and-hold-to-view-more-options = Tryck och håll för att se fler alternativ
...
Recording-stopped-Tap-to-play-the-current-recording = Inspelning avslutad. Tryck för att spela upp den aktuella inspelningen.
...
RESEARCH-GRADE--quality-grade = FORSKNINGSKLASS
Research-Grade-Status = Status för forskningsklass
...
Search-for-a-location = Sök efter en plats
...
Sign-in-with-Apple-Failed = Kunde inte logga in med Apple
Sign-in-with-Google = Logga in med Google
Sign-in-with-Google-Failed = Lyckades inte logga in med Google
...
Sort-by = Sortera efter
SORT-OBSERVATIONS = SORTERA OBSERVATIONER
...
Species = Art
Species-I-havent-observed = Arter som jag inte har observerat
Species-View = Artvy
Species-with-the-least-observations-appear-first = Arter med minst antal fynd visas först
Species-with-the-most-observations-appear-first = Arter med flest antal fynd visas först
...
Still-loading = Laddar fortfarande...
...
That-email-is-already-associated-with-an-account = Den e-postadressen är redan kopplad till ett konto.
That-user-profile-doesnt-exist = Den användarprofilen finns inte
That-username-is-unavailable = Det användarnamnet är inte tillgängligt
The-AI-is-not-confident-It-may-be-one-of-the-IDs-below = AI:n är inte säker. Det kan vara en av bestämningarna nedan.
The-AI-is-not-confident-Upload-to-ask-the-community = AI:n är inte säker. Ladda upp för att fråga communityn.
...
The-iNaturalist-community-will-help-verify-and-refine-identifications = iNaturalist-communityt kommer hjälpa till att verifiera och förbättra bestämningar av dina fynd för att skapa data av forskningsklass för vetenskap och naturvård.
...
This-observation-has-no-comments-or-identifications-yet = Detta fynd har inga kommentarer eller bestämningar ännu.
This-observation-has-not-met-the-conditions-required-to-meet-Research-Grade = Detta fynd uppfyller inte de villkor som ställts för att uppnå statusen forskningsklass
This-observation-is-not-eligible-for-research-grade-status = Detta fynd kan inte få statusen forskningsklass. Läs mer i Datakvalitetssäkringen nedan.
This-observation-is-research-grade-and-can-be-used-by-scientists = Detta fynd har forskningsklass och kan användas av forskare!
This-observation-needs-more-identifications = Detta fynd behöver fler bestämningar för att nå statusen forskningsklass
...
Traditional-Projects = Traditionella projekt
...
Upload-photos = Ladda upp bilder
...
Upload-your-observations-to-contribute-data-to-help-save-species = Ladda upp dina fynd för att bidra med data som hjälper till att rädda arter.
...
Use-iNaturalist-to-identify-any-living-thing = Använd iNaturalist för att bestämma allt levande
USE-LOCATION = ANVÄND PLATS
Use-the-devices-other-camera = Använd enhetens andra kamera.
Use-the-iNaturalist-camera-to-see-real-time-identifications-and-take-photos = Använd iNaturalist-kameran för att se artbestämningar i realtid och ta bilder!
Use-your-devices-microphone-to-record-animal-sounds-and-share-them = Använd din enhets mikrofon för att spela in djurläten och dela dem för att få artbestämningar och bidra till vetenskapen!
USER = ANVÄNDARE
User = Användare { $userHandle }
USERNAME-OR-EMAIL = ANVÄNDARNAMN ELLER E-POST
Users = Användare
Using-location = Använder platstjänst
Verified-IDs-are-used-for-science-and-conservation = Verifierade artbestämningar används inom vetenskapen och naturvården
...
Watch-your-notifications-for-identifications = Kolla dina aviseringar för artbestämningar!
...
You-may-have-observed-a-species-in-this-group = Du kanske har observerat en art i denna grupp
You-may-have-observed-this-species = Du kanske har observerat den här arten
You-may-notice-changes-to-how-things-look-and-flow = Du kan lägga märke till förändringar av utseendet och flödet. Du kan styra dina alternativ i inställningarna.
...
Your-observations-can-help-science = Dina fynd kan hjälpa vetenskapen!
Youre-ready-to-share-your-observations = Du är redo att dela med dig av dina fynd!
