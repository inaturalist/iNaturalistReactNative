...
Data-quality-assessment-date-specified = Angivet datum
...
# Data Quality Assessment metric
Data-quality-assessment-single-subject = Stöd kopplat till ett enstaka område
...
Edit-location = Ändra plats
Edit-Observation = Redigera observation
