...
After-capturing-or-importing-photos-show = Iškirpus ar importavus nuotraukas, rodoma:
Agree = Sutikti
AGREE = SUTINKU
...
ALL = VISI
All = Visi
All-observation-options--list = Visos stebėjimo parinktys: iNaturalist DI kamera, Standartinė kamera, Įkėlimas iš nuotraukų bibliotekos ir Garso įrašytuvas
All-observations = Visi stebėjimai
All-observations-need-a-date-and-location-to-be-used-for-science = Visiems stebėjimams reikia datos ir vietos, kad būtų panaudoti mokslui. Suredaguokite stebėjimus, jei jiems reikia daugiau informacijos.
...
CHOOSE-A-USERNAME = PASIRINKTI VARTOTOJO VARDĄ
...
Community-Discussion = Bendruomenės diskusija
Community-Guidelines = Bendruomenės gairės
COMMUNITY-GUIDELINES = COMMUNITY GUIDELINES
Confidence--label = Patikimumas
CONFIRM = CONFIRM
Congratulations-You-made-your-first-observation = Sveikiname! Jūs atlikote savo pirmąjį stebėjimą!
...
Disable-location = Išjungti vietovę
...
DONE = DONE
Dont-have-an-account = <0>Neturite paskyros? </0><1>Sign up</1>
...
Enable-location = Įjungti vietovę
...
Get-feedback-from-naturalists-and-experts-who-will-help-verify = Gaukite gamtininkų ir ekspertų, kurie padės jums patvirtinti ir patikslinti savo identifikacijas, atsiliepimų.
...
HELP = HELP
Help-create-Research-Grade-data-used-in-science-and-conservation = Padėkite kurti identifikuotus duomenis, naudojamus mokslui ir apsaugai.
Help-protect-species = Help protect species
Hide = Paslėpti
Highest = Highest
HIGHEST-RANK = HIGHEST RANK
I-agree-to-the-Terms-of-Use = <0>Aš sutinku su Sąlygomis bei Privatumo politika ir peržiūrėjau Bendruomenės gaires (</0><1>required</1><0>).</0>
Iconic-taxon-name = Iconic taxon name: { $iconicTaxon }
ID-Suggestions = ID pasiūlymai
...
Lets-reset-your-password = Nustatykime slaptažodį iš naujo.
...
March = Kovas
Match-Screen = Atitikties ekranas
...
Offensive-Inappropriate-Examples =
    Klaidinantis arba neteisėtas turinys, rasiniai ar etniniai įžeidimai ir t. t.
    Dėl išsamesnės informacijos apie mūsų apibrėžtį „tinkamas“ žr. DUK.
Offline-DQA-description = The DQA may not be accurate. Check your internet connection and try again.
Offline-suggestions-may-differ-from-online = Pasiūlymai neprisijungus gali skirtis nuo pasiūlymų prisijungus, o taksonų vaizdai ir bendrieji pavadinimai gali nesikrauti.
OK = Gerai
...
OR-SIGN-IN-WITH = ARBA PRISIJUNKITE SU
...
Please-choose-a-different-password = Pasirinkit ekitokį slaptažodį.
Please-Grant-Permission = Please Grant Permission
PLEASE-LOG-IN = PLEASE LOG IN
Please-make-sure-your-password-is-at-least-6-characters = Užtikrinkite, kad jūsų slaptažodis būtų bent 6 simbolių.
...
RESEARCH-GRADE--quality-grade = IDENTIFIKUOTAS
Research-Grade-Status = Identifikuoto būsena
...
Sign-in-with-Apple = Prisijungti su „Apple“
...
That-email-is-already-associated-with-an-account = Šis el. pašto adresas jau yra susietas su paskyra.
That-user-profile-doesnt-exist = That user profile doesn't exist
That-username-is-unavailable = Šis vartotojo vardas negalimas
...
This-is-your-identification-other-people-may-help-confirm-it = Tai jūsų identifikacija. Kiti žmonės gali padėti tai patvirtinti!
...
This-observation-is-not-eligible-for-research-grade-status = Šis stebėjimas netinka identifikavimo būsenai. Sužinokite daugiau tolesniame duomenų kokybės įvertinime.
This-observation-is-research-grade-and-can-be-used-by-scientists = Šis stebėjimas yra identifikavimo būsenos ir jį gali naudoti mokslininkai!
...
Upload-photos-from-your-photo-library = Įkelkite kelias nuotraukas į savo fotografijų biblioteką
...
Use-iNaturalist-to-identify-any-living-thing = Naudokite iNaturalist, kad identifikuotumėte bet kokį gyvą organizmą
...
Users = Vartotojai
Using-location = Vietovės naudojimas
...
You-likely-observed-a-species = Greičiausia stebėjote rūšį
You-likely-observed-an-organism-in-this-group = Greičiausia stebėjote šios grupės organizmą
...
You-may-have-observed-an-organism-in-this-group = Gali būti, kad stebėjote šios grupės organizmą
...
You-observed-an-organism-in-this-group = Stebėjote šios grupės organizmą
