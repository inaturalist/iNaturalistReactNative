...
ALL = VISI
All = Visi
All-observation-options = Visos stebėjimų parinktys (įskaitant iNaturalist DI kamerą, Standartinę kamerą, Įkėlimą iš fotografijų bibliotekos ir Garso įrašytuvą)
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist gali įrašyti nuotraukas, kurias jūs nufotografavote programėlėje, į jūsų įrenginio fotografijų biblioteką.
INATURALIST-COMMUNITY = INATURALIST COMMUNITY
iNaturalist-couldnt-identify-this-organism = iNaturalist negalėjo identifikuoti šio organizmo.
...
Save-photos-to-your-photo-library = Įraįykite nuotraukas į savo fotografijų biblioteką
