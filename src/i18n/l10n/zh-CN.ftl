...
Closes-new-observation-explanation = 关闭新的观察说明。
...
Getting-an-even-more-accurate-ID = 正在获取更精确的鉴定结果…
Go-back = 返回
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-library = <strong>保存照片</strong>：iNaturalist 可以将您在应用程序中拍摄的照片保存到您设备的图库中。
...
Navigates-to-match-screen = 跳转至匹配界面
...
SAVE-LOCATION = 保存位置
SAVE-PHOTOS = 保存照片
Save-photos-to-your-library = 保存照片到您的照片库
...
Skip-additional-suggestions = 忽略更多推荐
Skip-for-now = 暂时跳过
...
UPLOAD-NOW = 现在上传
Upload-photos-from-your-photo-library = 从您的照片库上传多张照片
...
You-likely-observed-a-species = 您可能观察到了某一物种
You-likely-observed-an-organism-in-this-group = 您可能观察到了该分类群中的生物个体。
You-may-have-observed-a-new-species = 您可能观察到了一个新物种！
You-may-have-observed-a-species = 你可能观察到了一种物种。
You-may-have-observed-an-organism-in-this-group = 你可能在这个群体中观察到了一种生物。
...
You-observed-a-species = 你观察到了一个物种
You-observed-an-organism-in-this-group = 你在这个群体中观察到了一种生物
