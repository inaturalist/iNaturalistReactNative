...
ALL = 所有
All = 全部
All-observation-options = 所有观察选项（包括iNaturalist AI相机、标准相机、从图库中上传，以及录音机）
All-observations = 所有观察
All-observations-submitted-to-iNaturalist-need-a-date-and-location = 提交给iNaturalist 的所有观察都需要日期和位置才能对科学家有用。如果他们需要更多信息，请更新观察。
All-organisms = 所有有机体
...
CONFIRM = 确认
Congrats-on-making-your-first-observation = 恭喜您进行了第一次观察！
...
Get-identifications-from-real-people = 得到来自真人的鉴定。
...
Grow-your-collection = 增加您的收藏
HELP = 帮助
Hide = 隐藏
Highest = 最高
HIGHEST-RANK = 最高排名
How-does-it-feel-to-identify = 鉴定并连接到您周围的自然感觉如何？
...
If-you-took-the-original-photo-you-can-help = 如果您拍摄了该生物的原始照片，您可以通过保存并上传到iNaturalist来帮助训练iNaturalist识别该物种，那里将有社区帮助进行鉴定。
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist 可以将您在应用程序中拍摄的照片保存到您设备的相册。
INATURALIST-COMMUNITY = INATURALIST社群
iNaturalist-couldnt-identify-this-organism = iNaturalist 无法鉴定这个生物。
...
Once-youve-uploaded-to-iNaturalist = 一旦您上传到 iNaturalist，我们社群中的其他自然人可以帮助确认您的鉴定。关注您的通知以便更新！
Open = 公开
OPEN-EMAIL = 打开邮件
Open-menu = 打开菜单。
OPEN-SETTINGS = 打开设置
...
Other = 其他
OTHER-DATA = 其他数据
Other-members-of-our-community-can-verify = 如果您上传给iNaturalist，我们社群的其他成员可以验证和鉴定您的观察。
...
Use-iNaturalist-to-collect-any-kind-of = 使用 iNaturalist 收集任何种类的植物、昆虫、蜘蛛、鸟类或其他动物并将其添加到您的观察记录中！
...
Weve-made-some-updates = 我们已经做了一些更新，所以我们建议查看您的设置。您可以随时更新。
...
You-make-an-observation-every-time-you = 每当你拍摄一个具有日期和位置的生物时，你都会进行观察。
...
Your-observations-can-help-scientists = 您的观察可以帮助科学家！
Your-observations-can-now-help-scientists = 您的观察现在可以帮助科学家。
...
Youve-made-2-observations = 您已经发布了2个观察！
