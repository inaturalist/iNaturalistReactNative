...
A-global-community-for-nature = 全球自然社区
ABOUT = 关于
...
Affiliation = 所属：{ $site }
After-capturing-or-importing-photos-show = 在抓取或导入照片后，显示：
Agree = 同意
AGREE = 同意
...
ALL = 所有
All = 全部
All-observation-options--list = 所有观察选项（包括iNaturalist AI相机、标准相机、从图库中上传，以及录音机）
All-observations = 所有观察
All-observations-need-a-date-and-location-to-be-used-for-science = 提交给iNaturalist 的所有观察都需要日期和位置才能用于科学。如果他们需要更多信息，请编辑观察。
All-organisms = 所有有机体
...
Already-have-an-iNaturalist-account = 已经有 iNaturalist 帐户了？
Amphibians = Amphibians
An-Internet-connection-is-required = 需要互联网连接才能加载更多观察。
Analyzing-for-the-best-identification = 分析以获得最佳鉴定...
Any--date = 任意
...
Change-end-date = 更改截止日期
Change-observations-sort-order = 更改观测值排序顺序
Change-project = 更改项目
Change-species-sort-order = 物种排序顺序变更
...
CONFIRM = 确认
Congratulations-You-made-your-first-observation = 恭喜！您进行了第一次观察！
Connect-with-expert-naturalists = 与博物学专家联系
...
Create-observation-with-no-evidence = 创建一个没有证据的观察
DATA-QUALITY = 数据质量
...
DATE = 日期
Date = 日期
Date-Added-Newest-Default = 添加日期：最新（默认）
Date-Added-Oldest = 添加日期： 最早的
date-format-long = PP
...
Date-Observed-Newest = 观察日期：最新的
DATE-OBSERVED-NEWEST = 观察日期 - 从新至旧
Date-Observed-Oldest = 观察日期: 最早的
...
Date-uploaded-on-header-short = 上传于：
...
DISCOVER-NATURE-AROUND-YOU = 探索您周围的大自然
Dismiss-announcement = 关闭公告
Do-you-know-what-group-this-is-in = 你知道这属于哪个组吗？
DONATE = 捐款
DONATE-TO-INATURALIST = 捐助INATURALIST
DONE = 完成
Dont-have-an-account = <0>没有帐户？ </0><1>请注册</1>
...
EXPAND-MAP = 扩展地图
Experts-help-verify-and-improve-IDs = 专业人士帮助验证和改进鉴定
Explore = 探索
EXPLORE = 探索
...
Get-an-instant-ID-of-any-plant-animal-fungus = 获取任何植物、动物或真菌的即时鉴定结果
Get-feedback-from-naturalists-and-experts-who-will-help-verify = 从博物学家和专业人士那里获得反馈，他们将帮助您验证和完善您的鉴定。
Get-your-identification-verified-by-real-people = 由iNaturalist 社区中的真人鉴定您的身份
Go-back = 返回
Google-Play-Services-Not-Installed = Google Play 服务未安装
GRANT-PERMISSION = 授予权限
Grant-Permission-title = 授予权限
Group-Photos = 编组照片
Group-photos-onboarding = 把多张照片编组到观察中-要确保每个观察里只有一个物种
HELP = 帮助
Help-create-Research-Grade-data-used-in-science-and-conservation = 帮助创建用于科学和保护的研究级数据。
Help-protect-species = 帮助保护物种
Help-us-translate-the-app = 帮助我们翻译此应用
Hide = 隐藏
Highest = 最高
HIGHEST-RANK = 最高排名
I-agree-to-the-Terms-of-Use = <0>我同意使用条款和隐私政策，而且我已经审查了社群规范(</0><1>必需</1><0>)。</0>
...
IDENTIFY = 鉴定
Identify-organisms-in-real-time-with-your-camera = 用摄像头实时鉴定生物。
...
If-youre-an-experienced-user-try-switching-to-Advanced-Mode = 你上传了100多条观察。试试高级模式，了解更多添加和管理观测数据的方式。
...
Improve-suggestions-by-using-your-location = 使用您的位置信息改进建议
...
iNaturalist-can-use-your-location-to-give-you-better-identification-suggestions = iNaturalist 可以使用您的位置为您提供更好的鉴定建议。我们还使用它来帮助你找到附近看到的物种。共享您的位置可以更轻松地创建有用的科学数据。
...
iNaturalists-apps-are-designed-and-developed-3 = iNaturalist的应用是由iNaturalist 团队设计、开发和支持的：Yaron Budowski, Amanda Bullington, Tony Iwane, Johannes Klein, Patrick Leary, Joanne Lin, Scott Loarie, Abhas Misraraj, Sylvain Morin, Carrie Seltzer, Alex Shepard, Thea Skaff, Angie Ta, Ken-ichi Ueda, Kirk van Gorkom, Jason Walthall, & Jane Weeden。
...
It-might-be-one-of-these = 它可能是其中的一个
January = 一月
JOIN = 加入
Join-a-global-community-for-nature = 加入全球自然社区
JOIN-PROJECT = 加入项目
...
Learn-from-people-who-verify-and-refine-your-identifications = 向验证和改进您的鉴定的人学习。
Learn-More = 了解更多
...
Membership-in-this-project-is-by-invitation-only = 此项目的会员资格仅限邀请。如果您想加入，请联系管理员之一并请求邀请。
Menu = 选单
Missing-Date = 缺少日期
...
MOST-FAVED = 最多收藏
Most-faved = 最多收藏
Most-Observed-Default = 观察次数最多(默认)
MY-CONTENT--notifications = 我的内容
My-Observations = 我的观察记录
My-Observations--bottom-tab = 我的
Native = 本地
...
Observation-Copyright = 观察版权所有：© { $userName } · { $restrictions }
...
OBSERVED-AT--label = 观察于
OBSERVED-IN--label = 观察于
Observers = 观察者
...
Please-log-in-again = 请重新登录。我们偶尔需要刷新你的会话，以清除缓存数据，确保应用运行最佳。
...
Point-the-camera-at-an-animal-plant-or-fungus = 将相机对准动物、植物或真菌
...
Press-and-hold-to-view-more-options = 长按以查看更多选项
...
Recording-stopped-Tap-to-play-the-current-recording = 录制已停止。点击播放当前录制。
...
RESEARCH-GRADE--quality-grade = 研究级
Research-Grade-Status = 研究级别状态
RESET-PASSWORD = 重置密码
...
Sign-in-with-Apple = 使用Apple账号登陆
Sign-in-with-Apple-Failed = 使用Apple账号登录失败
Sign-in-with-Google = 使用Google登录
Sign-in-with-Google-Failed = 使用Google登录失败
Skip-for-now = 暂时跳过
...
Species-View = 物种浏览
Species-with-the-least-observations-appear-first = 观察最少的物种优先显示
Species-with-the-most-observations-appear-first = 观察最多的物种优先显示
...
That-email-is-already-associated-with-an-account = 该电子邮件已与一个帐户关联。
That-user-profile-doesnt-exist = 该用户信息不存在
That-username-is-unavailable = 该用户名不可用
The-AI-is-not-confident-It-may-be-one-of-the-IDs-below = AI 没有信心。它可能是以下鉴定结果之一。
The-AI-is-not-confident-Upload-to-ask-the-community = AI 没有信心。上传以询问社区。
The-exact-location-will-be-hidden = 确切的位置将公开隐藏，然后概括到更大的区域(受威胁和濒危物种自动被掩盖)。
The-iNaturalist-community-will-help-verify-and-refine-identifications = iNaturalist 社区将帮助验证和优化您的观测结果的鉴定，以创建用于科学和保护的研究级数据。
...
This-comment-was-hidden-for-violating-community-guidelines-or-terms = 本评论因违反社区准则或使用条款而被隐藏。
This-identification-was-hidden-for-violating-community-guidelines-or-terms = 该身份因违反社区准则或使用条款而被隐藏。
This-image-was-hidden-for-violating-community-guidelines-or-terms = 这张照片因违反社区准则或使用条款而被隐藏。
This-is-a-wild-organism = 这是一个野生生物，不是被人类放置在这个位置的。
This-is-how-taxon-names-will-be-displayed = 这是在整个iNaturalist站点上分类单元名称的显示方式：
This-is-your-identification-other-people-may-help-confirm-it = 这是您的鉴定。其他人可能会帮助确认它！
This-may-take-a-few-seconds = 这可能需要几秒钟。
This-observation-has-no-comments-or-identifications-yet = 此观察记录尚无评论或鉴定。
This-observation-has-not-met-the-conditions-required-to-meet-Research-Grade = 这个观察结果没有达到研究等级的条件。
This-observation-is-not-eligible-for-research-grade-status = 此观察记录不符合研究等级条件。请在下面的数据质量评估中了解更多信息。
This-observation-is-research-grade-and-can-be-used-by-scientists = 这个观察是研究等级，科学家可以使用！
This-observation-needs-more-identifications = 此观察记录需要更多的鉴定才能达到研究等级
...
This-sound-was-hidden-for-violating-community-guidelines-or-terms = 该声音因违反社区准则或使用条款而被隐藏。
...
Upload-your-observations-to-contribute-data-to-help-save-species = 上传您的观察结果以贡献数据以帮助拯救物种。
...
Use-iNaturalist-to-identify-any-living-thing = 使用 iNaturalist 来鉴定任何生物体
USE-LOCATION = 使用位置
Use-the-devices-other-camera = 使用设备的其他相机。
Use-the-iNaturalist-camera-to-see-real-time-identifications-and-take-photos = 使用 iNaturalist 相机查看实时鉴定并拍照！
Use-your-devices-microphone-to-record-animal-sounds-and-share-them = 使用您的设备的麦克风来录制由动物产生的声音并与我们的社群分享以获得鉴别并为科学做出贡献！
USER = 用户
User = 用户 { $userHandle }
USERNAME-OR-EMAIL = 用户名或电子邮件
Users = 用户
Using-location = 运用位置
Verified-IDs-are-used-for-science-and-conservation = 经过验证的鉴定被用于科学和保护
...
Watch-your-notifications-for-identifications = 注意您获得鉴定的通知！
...
You-have-no-notifications-you-will-see-updates-to-obs-you-have-left-IDs-or-comments-on = 您没有通知！您将看到您在这里留下的 ID 或评论的观察的更新。
...
Your-observations-can-help-science = 您的观察现在可以为科学做出贡献！
Youre-ready-to-share-your-observations = 您已准备好分享您的观察结果！
