...
All-required-fields-have-been-filled = Semua bidang yang harus diisi telah diisi
...
Change-observations-sort-order = Ubah urutan pengamatan
Change-project = Ganti proyek
Change-species-sort-order = Ubah urutan spesies
...
Dismiss-announcement = Tutup pengumuman
...
Enter-a-response = Masukkan jawaban
Error = Kesalahan
ERROR = EROR
...
Filters = Saringan
Filters-observations-to-anywhere-in-the-world = Saring pengamatan ke suatu tempat di dunia.
Filters-observations-to-your-current-location = Saring pengamatan ke lokasi Anda sekarang.
Fish = Ikan
...
Help-us-translate-the-app = Bantu kami terjemahkan aplikasi ini!
Hide = Sembunyikan
Highest = Tertinggi
...
If-youre-an-experienced-user-try-switching-to-Advanced-Mode = Anda telah mengunggah lebih dari 100 pengamatan. Coba Mode Lanjutan untuk lebih banyak cara menambahkan dan mengelola pengamatan.
...
Kelp-and-Diatoms = Rumput Laut & Diatom
...
Least-Observed = Paling Jarang Diamati
LEAVE = KELUAR
...
Most-faved = Paling favorit
Most-Observed-Default = Paling Sering Diamati (Bawaan)
...
Restore = Pulihkan
RETURN-TO-STANDARD-SEARCH = KEMBALI KE PENCARIAN STANDAR
Reveal = Tampilkan
...
Select-a-response = Pilih jawaban
Select-a-species = Pilih spesies
...
Selects-iconic-taxon-X = Memilih takson ikonik { $iconicTaxon }.
...
Species = spesies
Species-I-havent-observed = Spesies yang belum saya amati
Species-View = Tampilan Spesies
Species-with-the-least-observations-appear-first = Spesies dengan jumlah pengamatan paling sedikit ditampilkan terlebih dahulu
Species-with-the-most-observations-appear-first = Spesies dengan jumlah pengamatan terbanyak ditampilkan terlebih dahulu
...
To-add-to-this-project-all-required-fields-must-be-filled = Untuk menambahkan ke proyek ini, semua bidang yang wajib diisi harus diisi
...
Toggles-the-section-open-or-closed = Membuka atau menutup bagian.
