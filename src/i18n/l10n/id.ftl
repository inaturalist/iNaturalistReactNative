...
ALL = SEMUA
All = Semua
All-observation-options = Semua pilihan pengamatan (termasuk Kamera AI iNaturalist, Kamera Standar, Mengunggah dari Galeri Gambar, dan Perekam Suara)
All-observations = Semua pengamatan
All-observations-submitted-to-iNaturalist-need-a-date-and-location = Semua pengamatan yang dikumpulkan ke iNaturalist memerlukan tanggal dan lokasi supaya bisa menjadi berguna untuk para ilmuwan. Harap perbarui pengamatan jika mereka memerlukan informasi tambahan.
...
CONFIRM = KONFIRMASI
Congrats-on-making-your-first-observation = Selamat karena sudah membuat pengamatan pertama!
...
Get-identifications-from-real-people = Dapatkan identifikasi dari orang lain.
...
Grow-your-collection = Kembangkan koleksimu
HELP = BANTUAN
Hide = Sembunyikan
Highest = Tertinggi
HIGHEST-RANK = TINGKAT TERTINGGI
How-does-it-feel-to-identify = Bagaimana rasanya untuk mengidentifikasi dan terhubung dengan alam di sekitarmu?
...
If-you-took-the-original-photo-you-can-help = Jika Anda mengambil gambar organisme aslinya, Anda bisa membantu melatih iNaturalist untuk mengidentifikasi spesies ini dengan menyimpan dan mengunggahnya ke iNaturalist, sehingga komunitasnya bisa membantu mengidentifikasinya.
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist dapat menyimpan gambar yang Anda ambil di aplikasi ke galeri perangkat Anda.
INATURALIST-COMMUNITY = KOMUNITAS INATURALIST
iNaturalist-couldnt-identify-this-organism = iNaturalist tidak bisa mengidentifikasi organisme ini.
...
Save-photos-to-your-photo-library = Simpan foto ke galeri Anda
...
Your-observations-can-help-scientists = Pengamatanmu bisa membantu ilmuwan!
Your-observations-can-now-help-scientists = Pengamatanmu bisa membantu ilmuwan sekarang.
...
Youve-made-2-observations = Kamu telah membuat 2 pengamatan!
