...
Flag-Item-Other-Description = Alguma outra razão que você pode explicar depois.
Flag-Item-Other-Input-Hint = Especifique o motivo pelo qual você está sinalizando este item
