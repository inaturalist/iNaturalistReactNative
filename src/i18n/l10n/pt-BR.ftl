...
Advanced--interface-mode-with-explainer = Avançado (carregar várias fotos e sons)
...
FOLLOW = SEGUIR
FOLLOWING--notifications = SEGUINDO
FOLLOWING-X-PEOPLE =
    { $count ->
...
INATURALIST-MODE = MODO INATURALIST
