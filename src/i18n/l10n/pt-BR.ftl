...
Getting-an-even-more-accurate-ID = Obtendo uma ID ainda mais precisa...
Go-back = Voltar
...
If-you-hold-down-instead-of-tapping-the-camera-button-you-can = Se você pressionar (ao invés de clicar) o botão da câmera, você poderá gravar sons, tirar várias fotos e importar de sua galeria de fotos.
...
More-ways-to-observe = Mais maneiras de observar
...
You-likely-observed-an-organism-in-this-group = Você provavelmente observou um organismo nesse grupo
...
You-may-have-observed-an-organism-in-this-group = Você pode ter observado um organismo nesse grupo
