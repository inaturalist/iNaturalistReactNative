...
Agree = Concordar
AGREE = CONCORDO
Agree-to-all-of-the-above = Concordar com todos os itens acima
...
ALL = TODOS
All = Todas
All-observation-option = Todas as opções de observação (incluindo câmera IA iNaturalista, câmera normal, fazendo ‘upload’ da galeria, e gravador de som)
...
As-you-upload-more-observations = Conforme você envia mais observações, outros em nossa comunidade podem ajudá-lo a identificá-las!
...
Check-this-box-if-you-want-to-apply-a-Creative-Commons = Marque esta caixa se você quer aplicar uma licença não comercial de atribuição de Direitos Autorais ao conteúdo enviado. Isto significa que qualquer pessoa pode copiar e reutilizar suas fotos e/ou observações sem pedir autorização, desde que lhe conceda crédito e não utlize as obras comercialmente. Você pode escolher uma licença diferente ou remover a licença depois, porém esta é a melhor licença para compartilhar com pesquisadores.
CHECK-YOUR-EMAIL = VERIFICE O SEU EMAIL!
CHOOSE-PHOTOS = ESCOLHA FOTOS!
...
CREATE-YOUR-FIRST-OBSERVATION = CRIAR SUA PRIMEIRA OBSERVAÇÃO
...
Data-quality-casual-description = Esta observação necessita de mais informações verificadas para ser considerada verificável
Data-quality-needs-id-description = Esta observação necessita de mais identificações para alcançar a classe de pesquisa
Data-quality-research-description = Esta observação contém identificações suficientes para ser considerada classe de pesquisa
DATE = DATA
Date = Data
date-format-long = PP
date-format-month-day = d MMM
date-format-month-year = MM AA
...
DONE = CONCLUÍDO
Dont-have-an-account = Não tem uma conta? Registre-se
...
Flag-Item-Description =
    A sinalização chama a atenção dos curadores voluntários do site.
    Por favor, não sinalize problemas que você pode resolver com identificações, com a Avaliação de Qualidade dos Dados ou conversando com a pessoa que fez o conteúdo.
Flag-Item-Other = Marcado como Outra Caixa de Descrição
...
Get-more-accurate-suggestions-create-useful-data = Obtenha sugestões mais precisas e crie dados úteis para a ciência usando sua localização
...
I-agree-to-the-Terms-of-Use = Eu concordo com os Termos de Uso e Política de Privacidade e revisei as Diretrizes da Comunidade (obrigatório).
I-consent-to-allow-iNaturalist-to-store = Eu concordo em permitir que o iNaturalist armazene e processe tipos limitados de informações pessoais sobre mim para gerenciar minha conta (obrigatório)
I-consent-to-allow-my-personal-information = Eu concordo em permitir que minhas informações pessoais sejam transferidas para os Estados Unidos da América. Saiba mais (obrigatório)
...
Obscured = Oculta
Obscured-observation-location-map-description = A localização desta observação é oculta. Você está vendo um ponto aleatório no polígono de ocultação.
...
Please-Allow-Gallery-Access = Por favor, permita o acesso à galeria
...
Please-click-the-link = Por favor, clique no link no e-mail dentro de 60 minutos para confirmar sua conta
...
Recording-stopped-Tap-play-the-current-recording = Gravação parada. Toque em reproduzir a gravação atual.
...
Save-photos-to-your-gallery = Salvar fotos na sua galeria
Saved-Observation = Observação salva, na fila para carregar
Scan-the-area-around-you-for-organisms = Escaneie a área ao seu redor para os organismos.
...
See-all-your-observations-in-explore = Ver todas as suas observações em explorar
See-observations-by-this-user-in-Explore = Ver observações deste usuário em Explorar
See-observations-in-explore = Ver observações em explorar
...
Some-data-privacy-laws = Algumas leis de privacidade de dados, como o Regulamento Geral de Proteção de Dados da União Europeia (RGPD), exigem o consentimento explícito para transferir informação pessoal das suas jurisdições para outras jurisdições onde a proteção jurídica desta informação não seja considerada adequada. A partir de 2020, a União Europeia já não considera os Estados Unidos como uma jurisdição que proporciona uma proteção jurídica adequada da informação pessoal, especificamente devido à possibilidade de o governo dos Estados Unidos controlar os dados que entram nesse país. É possível que outras jurisdições tenham a mesma opinião.
...
Text-Box-to-Describe-Reason-for-Flag = Caixa de texto para descrever o motivo do sinalizador.
...
To-learn-more-about-what-information = Para saber mais sobre quais informações coletamos e como as utilizamos, consulte a nossa Política de Privacidade e os nossos Termos de Uso.
...
Upload-photos-from-your-gallery = Envie várias fotos da sua galeria
Upload-photos-from-your-gallery-and-create-observations = Carregue fotos da sua galeria, crie observações e obtenha identificações de organismos que você já observou!
...
Users = Usuários
Using-iNaturalist-requires-the-storage = O uso do iNaturalist requer o armazenamento de informações pessoais como o seu endereço eletrônico, todos os dados do iNaturalist são armazenados nos Estados Unidos, e não podemos ter certeza de qual jurisdição legal você está usando o iNaturalist, para cumprir as leis de privacidade como o RGPD, você deve reconhecer que entende e aceita esse risco e dar autorização para transferir suas informações pessoais para os servidores do iNaturalist nos EUA.
...
Welcome-user = <0>Bem-vindo de volta,</0><1>{ $userHandle }</1>
...
You-can-also-explore-existing-observations = Você também pode explorar observações existentes no iNaturalist para descobrir o que está ao seu redor.
...
You-can-search-observations-of-any-plant-or-animal = Você pode pesquisar observações de qualquer planta ou animal em qualquer lugar do mundo com a Exploração!
...
Youre-always-in-control-of-the-location-privacy = Você sempre está no controle da privacidade da localização de cada observação que criar.
