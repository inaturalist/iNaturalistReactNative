...
Change-end-date = Alterar data final
Change-observations-sort-order = Alterar ordem de apresentação das observações
Change-project = Alterar projeto
Change-species-sort-order = Alterar ordem de organização das espécies
...
Create-observation-with-no-evidence = Criar observação sem evidências
...
Help-us-translate-the-app = Ajude a traduzir o app
Hide = Ocultar
Highest = Mais Alto
...
If-youre-an-experienced-user-try-switching-to-Advanced-Mode = Você carregou mais de 100 observações. Experimente o Modo Avançado para mais formas de adicionar e gerenciar observações.
...
Least-Observed = Menos Observados
LEAVE = DEIXAR
...
Most-faved = Mais favoritados
Most-Observed-Default = Mais observados (Padrão)
...
Navigates-to-log-in-screen = Navega até a tela de login
Navigates-to-main-menu = Navega até o menu principal.
...
See-journal-posts = Ver postagens de boletins
...
Species-with-the-least-observations-appear-first = Espécies com menos observações aparecem primeiro
Species-with-the-most-observations-appear-first = Espécies com mais observações aparecem primeiro
...
Tap-here-to-switch-to-Advanced-Mode = Toque aqui para mudar para o Modo Avançado
Taxa = Táxons
TAXON = TÁXON
...
This-comment-was-hidden-for-violating-community-guidelines-or-terms = Este comentário foi ocultado por violar as Diretrizes da Comunidade ou os Termos de Uso.
This-identification-was-hidden-for-violating-community-guidelines-or-terms = Essa identificação foi ocultada por violar as Diretrizes da Comunidade ou os Termos de Uso.
This-image-was-hidden-for-violating-community-guidelines-or-terms = Esta foto foi ocultada por violar as Diretrizes da Comunidade ou os Termos de Uso.
...
This-sound-was-hidden-for-violating-community-guidelines-or-terms = Este som foi ocultado por violar as Orientações Comunitárias ou os Termos de Uso.
This-user-has-no-followers = Esse usuário não tem seguidores.
This-user-has-not-joined-any-projects = Esse usuário não participa de projetos
This-user-is-not-following-anyone = Este usuário não segue outros usuários
...
X-JOURNAL_POSTS =
    { $count ->
       ...
       *[other] { $count } PUBLICAÇÕES DE BOLETIM
    }
X-MEMBERS =
    { $count ->
        [one] { $count } MEMBRO
