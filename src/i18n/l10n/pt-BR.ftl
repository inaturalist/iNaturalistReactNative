...
ALL = TODOS
All = Todas
All-observation-options = Todas as opções de observação (incluindo câmera IA iNaturalist, câmera normal, carregar fotos da galeria, e gravador de som)
All-observations = Todas as observações
All-observations-submitted-to-iNaturalist-need-a-date-and-location = Todas as observações enviadas ao iNaturalist precisam de uma data e localização para serem úteis aos cientistas. Favor atualizar as observações se precisarem de mais informações.
...
CONFIRM = CONFIRMAR
Congrats-on-making-your-first-observation = Parabéns por enviar a sua primeira observação!
...
Get-identifications-from-real-people = Obtenha identificações de pessoas reais.
...
Grow-your-collection = Aumente sua coleção
HELP = AJUDA
Hide = Ocultar
Highest = Mais Alto
HIGHEST-RANK = RANQUE MAIS ALTO
How-does-it-feel-to-identify = Como se sente ao identificar e se conectar à natureza ao seu redor?
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist pode salvar as fotos que você tira no aplicativo na sua galeria do seu dispositivo.
INATURALIST-COMMUNITY = COMUNIDADE INATURALISTA
iNaturalist-couldnt-identify-this-organism = iNaturalist não conseguiu identificar este organismo.
...
Offensive-Inappropriate-Examples = Conteúdo enganoso ou ilegal, insultos racistas ou étnicos, etc. Para saber mais sobre a nossa definição de "apropriado", veja as perguntas frequentes.
...
Once-youve-uploaded-to-iNaturalist = Após enviar para o iNaturalist, outros naturalistas da nossa comunidade podem ajudar a confirmar suas identificações. Acompanhe suas notificações para atualizações!
Open = Aberta
...
Other-members-of-our-community-can-verify = Outros membros da nossa comunidade podem verificar e identificar suas observações se você enviá-las para o iNaturalist.
...
Save-photos-to-your-photo-library = Salvar fotos na sua galeria
...
Scientists-use-citizen-science-data = Cientistas usam dados de ciencia-cidadã como os seus para ajudar a entender melhor as espécies em todo o mundo.
SEARCH = PESQUISAR
Search = Pesquisar
...
Use-iNaturalist-to-collect-any-kind-of = Use o iNaturalist para registrar qualquer tipo de planta, fungo, inseto, aranha, pássaro ou outro animal e adicioná-los às suas observações!
...
Weve-made-some-updates = Fizemos algumas atualizações, então recomendamos rever suas configurações,. Você poderá atualizá-las mais tarde.
...
You-make-an-observation-every-time-you = Você faz uma observação sempre que tira uma foto de um organismo com uma data e um local.
...
Your-observations-can-help-scientists = Suas observações podem ajudar os cientistas!
Your-observations-can-now-help-scientists = Agora suas observações podem ajudar os cientistas!
...
Youve-made-2-observations = Você fez 2 observações!
