...
Flag-Item-Description = El marcado llama la atención de los curadores voluntarios del sitio. Por favor, no señales los problemas que puedes solucionar con las identificaciones, la evaluación de la calidad de los datos o hablando con la persona que creó el contenido.
...
If-you-hold-down-instead-of-tapping-the-camera-button-you-can = Si mantienes pulsado (en lugar de tocar) el botón de la cámara, puedes grabar sonidos, tomar varias fotos e importarlas desde tu biblioteca de fotos.
...
More-ways-to-observe = Más formas de observar
...
Opens-the-side-drawer-menu = Abre el menú del cajón lateral.
