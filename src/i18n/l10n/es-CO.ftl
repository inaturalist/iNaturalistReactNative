...
Check-this-box-if-you-want-to-apply-a-Creative-Commons = Marque esta casilla si desea aplicar una licencia de Creative Commons de reconocimiento no-comercial al contenido subido. Esto significa que cualquiera puede copiar y reutilizar sus fotos y/o observaciones sin pedir permiso, siempre y cuando le den crédito y no utilicen los trabajos con fines comerciales. Puede elegir una licencia diferente o eliminar la licencia más adelante, pero esta es la mejor licencia para compartir con investigadores.
...
CONTINUE = CONTINUAR
Continue-to-iNaturalist = Continuar a iNaturalist
...
DONE = HECHO
Dont-have-an-account = ¿Aún no tiene una cuenta? Regístrese
...
I-agree-to-the-Terms-of-Use = Estoy de acuerdo con los Términos de Uso y la Política de Privacidad, y he revisado las Directrices de la Comunidad (requerido).
I-consent-to-allow-iNaturalist-to-store = Autorizo a iNaturalist a almacenar y procesar ciertos tipos de información personal para administrar mi cuenta (requerido)
I-consent-to-allow-my-personal-information = Doy mi consentimiento para que mi información personal sea transferida a los Estados Unidos de América. Saber más
...
Identify-an-organism-with-the-iNaturalist-AI-Camera = Identificar un organismo con la cámara iNaturalist IA
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-gallery = iNaturalist puede guardar las fotos que tomas en la aplicación en la galería de tu dispositivo.
