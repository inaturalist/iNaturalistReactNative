...
Casual--quality-grade = കാഷ്വൽ
# label in project requirements
Date = തീയതി
Delete-observation = നിരീക്ഷണം ഇല്ലാതാക്കുക
...
Edit = എഡിറ്റുചെയ്യുക
Edit-Observation = നിരീക്ഷണം എഡിറ്റുചെയ്യുക
Exact-Date = സത്യമായ തീയതി
# Identification category
improving--identification = മെച്ചപ്പെടുത്തുന്നു
# Identification category
leading--identification = നയിക്കുന്നു
# Identification category
maverick--identification = മാവെറിക്
