...
Collection-Project = Zbirni projekt
...
Coordinates-copied-to-clipboard = Koordinate spremljene u međuspremnik
...
Data-quality-assessment-date-is-accurate = Datum je točan
# Data Quality Assessment section label: whether or not the observation date was specified
Data-quality-assessment-date-specified = Datum je određen
...
Data-quality-assessment-evidence-of-organism = Dokaz o organizmu postoji
# Data Quality Assessment metric
Data-quality-assessment-has-photos-or-sounds = Ima sliku ili zvuk
# Data Quality Assessment metric
Data-quality-assessment-id-supported-by-two-or-more = ID je podržan od barem dvoje ljudi
# Data Quality Assessment metric
Data-quality-assessment-location-is-accurate = Lokacija je točna
# Data Quality Assessment metric
Data-quality-assessment-location-specified = Lokacija je određena
# Data Quality Assessment metric
Data-quality-assessment-organism-is-wild = Organizam je divlji
# Data Quality Assessment metric
Data-quality-assessment-recent-evidence-of-organism = Dokaz o organizmu je relativno nedavan
# Data Quality Assessment metric
Data-quality-assessment-single-subject = Dokaz vezan za jedan predmet
...
Data-quality-assessment-title-research = Ovo opažanje je ocijenjeno istraživačkom ocijenom!
...
Date-observed = Datum opažanja
Date-observed-header-short = Zabilježeno
...
Delete-observation = Izbriši opažanje
...
Edit-location = Edit location
Edit-Observation = Uredi opažanje
...
# label in project requirements
Establishment = Način ustanovljenja
...
Flag-Item-Other-Description = Neki drugi razlog možete objasniti u nastavku.
Flag-Item-Other-Input-Hint = Navedite razlog za označavanje ove stavke
...
ID-Withdrawn = Identifikacija povučena
...
improving--identification = Napreduje
...
PROJECT = PROJECT
Project-Members-Only = Samo članovi projekta
...
# label in project requirements
Quality-Grade = Kvalitativna ocjena
...
Ranks-Parvorder = Parvrod
Ranks-PHYLUM = PHYLUM
Ranks-Phylum = Koljeno
Ranks-SECTION = SECTION
Ranks-Section = Sekcija
Ranks-SPECIES = VRSTE
Ranks-Species = Vrste
Ranks-Statefmatter = Stanje materije
Ranks-STATEOFMATTER = STATE OF MATTER
Ranks-SUBCLASS = SUBCLASS
Ranks-Subclass = Podrazred
...
Ranks-Variety = Varijetet
Ranks-ZOOSECTION = ZOOSECTION
Ranks-Zoosection = Zoosekcija
Ranks-ZOOSUBSECTION = ZOOSUBSECTION
Ranks-Zoosubsection = Zoopodsekcija
...
Remove-identification = Izbriši identifikaciju
Remove-Photos = Remove Photos
Remove-project-filter = Ukloni filtar projekta
...
Research-Grade--quality-grade = Istraživačka ocjena
...
Share-location = Podijelite lokaciju
Share-map = Share map
...
Spam = Spam
Spam-Examples = Komercijalna ponuda, beskorisne poveznice, itd.
Species = Vrste
...
Suggest-ID = SUGGEST ID
# Identification category
supporting--identification = Podržavanje
...
Traditional-Project = Tradicionalni projekt
Umbrella-Project = Krovni projekt
UNFOLLOW = UNFOLLOW
...
View-in-browser = Otvori u pregledniku
...
# or photo
View-suggestions = Vidi prijedloge
...
You-need-log-in-to-do-that = Za to se morate prijaviti.
