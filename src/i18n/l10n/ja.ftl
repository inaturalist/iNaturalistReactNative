...
Observation = 観察記録
Observations = 観察記録
Observations-on-iNat-are-cited = iNaturalistの観察記録は科学論文に引用され、新たな発見につながり、科学者が地球上の生物について解明するのに役立っています。
Observe = 観察
Observe-and-identify-organisms-in-real-time-with-your-camera = カメラでリアルタイムに生物を観察し、同定します
Observers = 投稿者
October = 10月
OK = OK
Open = オープン
...
Use-the-iNaturalist-camera-to-observe-2 = iNaturalistを使ってリアルタイムで生物を観察し、同定しましょう。同定を行い、科学に貢献するために、私たちのコミュニティと共有しましょう！
Users = ユーザー
