...
All-required-fields-have-been-filled = Alle obligatoriske felter er udfyldt
...
Change-end-date = Skift slutdato
Change-observations-sort-order = Skift sorteringsrækkefølge for observationer
Change-project = Skift projekt
Change-species-sort-order = Skift sorteringsrækkefølge for arrter
...
Chooses-top-taxon = Vælg top-taxon
Close = Luk
...
Create-observation-with-no-evidence = Opret observation uden bevis
...
Dismiss-announcement = Afvis bekendtgørelse
...
Enter-a-response = Angiv et svar
Error = Fejl
ERROR = FEJL
...
Filters = Filtre
Filters-observations-to-anywhere-in-the-world = Filtrerer observationer til hvor som helst i verden.
Filters-observations-to-your-current-location = Filtrerer observationer til den aktuelle placering.
Fish = Fisk
Flagged = Markeret
Flash = Blitz
...
Help-us-translate-the-app = Hjælp os med at oversætte appen!
Hide = Skjul
Highest = Højeste
...
If-youre-an-experienced-user-try-switching-to-Advanced-Mode = Du har uploadet mere end 100 observationer. Prøv Avanceret tilstand for flere måder at tilføje og håndtere observationer på.
...
Kelp-and-Diatoms = Tang og Kiselalger
...
Least-Observed = Mindst observeret
LEAVE = FORLAD
...
Most-faved = Mest populære
Most-Observed-Default = Mest observeret (standard)
...
One-or-more-projects-still-need-required-info = Et eller flere projekter kræver stadig nødvendig info. Forlad nu, og kun de færdige gemmes.
Open = Åben
...
Select-a-response = Vælg et svar
Select-a-species = Vælg en art
...
Selects-iconic-taxon-X = Vælger ikonisk taxon { $iconicTaxon }.
...
Species = Art
Species-I-havent-observed = Art, man ikke har observeret
Species-View = Artsvisning
Species-with-the-least-observations-appear-first = Arter med færrest observationer vises først
Species-with-the-most-observations-appear-first = Arter med flest observationer vises først
...
To-add-to-this-project-all-required-fields-must-be-filled = For at føje til dette projekt skal alle obligatoriske felter udfyldes
...
Toggles-the-section-open-or-closed = Viser/skjuler afsnittet.
...
You-may-have-observed-a-species-in-this-group = Man har sandsynligvis observeret en art i denne gruppe
You-may-have-observed-this-species = Man har muligvis observeret denne art
