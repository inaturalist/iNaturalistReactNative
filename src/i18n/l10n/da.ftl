...
A-global-community-for-nature = Et globalt fællesskab for naturen
ABOUT = OM
...
ALL = ALLE
All = Alle
All-observation-options--list = Alle observationsvalgmuligheder: iNaturalist AI-kamera, Standardkamera, Upload fra Galleri og Lydoptager
All-observations = Alle observationer
All-observations-need-a-date-and-location-to-be-used-for-science = Alle observationer behøver en dato og placering for at være nyttige for videnskaben. Redigér observationer, hvis de behøver mere information.
...
CONFIRM = BEKRÆFT
Congratulations-You-made-your-first-observation = Tillykke! Den første observation er oprettet!
Connect-with-expert-naturalists = Forbind med ekspert-naturforskere
...
DISCOVER-NATURE-AROUND-YOU = OPLEV NATUREN OMKRING DIG
DISMISS = AFVIS
...
Experts-help-verify-and-improve-IDs = Eksperter hjælper med at bekræfte og forbedre ID'er
Explore = Udforsk
EXPLORE = UDFORSK
...
Get-an-instant-ID-of-any-plant-animal-fungus = Få en øjeblikkelig ID af enhver plante, dyr eller svamp
Get-feedback-from-naturalists-and-experts-who-will-help-verify = Få feedback fra naturforskere og eksperter, som vil hjælpe med at tjekke og forfine identifikationerne.
...
HELP = HJÆLP
Help-create-Research-Grade-data-used-in-science-and-conservation = Hjælp med at skabe Forskningskvalitetsdata, der anvendes inden for videnskab og bevaring.
Help-protect-species = Hjælp med at beskytte arter
Hide = Skjul
Highest = Højeste
...
Identify-organisms-in-real-time-with-your-camera = Identificér organismer i realtid med enhedens kamera
...
If-you-save-this-observation-and-upload-it-to-iNaturalist = Gemmes denne observation og uploades til iNaturalist, kan andre hjælpe med at identificere den.
...
Improve-suggestions-by-using-your-location = Forbedre forslag ved at brug af placeringen
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-library = iNaturalist kan gemme fotos taget i appen i enhedens Galleri.
...
It-might-be-one-of-these = Det kan være en af disse
January = Januar
JOIN = TILMELD
Join-a-global-community-for-nature = Bliv en del af globalt fællesskab for naturen
...
Learn-from-people-who-verify-and-refine-your-identifications = Høst erfaring fra personer, som bekræfter og forfine identifikationerne.
Learn-More = Lær mere
...
Point-the-camera-at-an-animal-plant-or-fungus = Ret kameraet mod et dyr, en plante eller svamp
...
Recording-stopped-Tap-to-play-the-current-recording = Optagelse stoppet. Tryk for at afspille den aktuelle optagelse.
...
Save-photos-to-your-library = Gem fotos i Galleri
...
The-AI-is-not-confident-It-may-be-one-of-the-IDs-below = AI'en er ikke sikker. Det kan være en af ID'erne nedenfor.
The-AI-is-not-confident-Upload-to-ask-the-community = AI'en er ikke sikker. Upload for at spørge fællesskabet.
...
The-iNaturalist-community-will-help-verify-and-refine-identifications = INaturalist-fællesskabet vil hjælpe med at bekræfte og forfine identifikationer på observationerne for at skabe Forskningskvalitetsdata til videnskab og bevaring.
...
Upload-your-observations-to-contribute-data-to-help-save-species = Upload observationerne for at bidrage med data som hjælp til at redde arter.
...
Use-the-iNaturalist-camera-to-see-real-time-identifications-and-take-photos = Benyt iNaturalist-kameraet til at se realtidsidentifikationer og tage fotos!
Use-your-devices-microphone-to-record-animal-sounds-and-share-them = Brug enhedens mikrofon til at optage dyrelyde, og del dem med vores fællesskab for at få identifikation og bidrage til videnskaben!
USER = BRUGER
User = Bruger { $userHandle }
USERNAME-OR-EMAIL = BRUGERNAVN ELLER E-MAIL
Users = Brugere
Using-location = Bruger placering
Verified-IDs-are-used-for-science-and-conservation = Bekræftede ID'er anvendes til videnskab og bevaring
Version-app-build = Version { $appVersion } ({ $buildVersion })
View-Advanced-Settings = Vis Avancerede indstillinger
...
You-may-notice-changes-to-how-things-look-and-flow = Man bemærke måske ændringer i tingenes udseende og flow. Man kan styre sine indstillinger via Indstillinger.
...
Your-observations-can-help-science = Observationerne kan hjælpe videnskaben!
Youre-ready-to-share-your-observations = Man er nu klar til at dele sine observationer!
