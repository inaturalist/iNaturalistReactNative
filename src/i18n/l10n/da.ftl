...
Advanced--interface-mode-with-explainer = Avanceret (upload flere fotos og lyde)
...
ALL = ALLE
All = Alle
All-observation-options = Alle observationsvalgmuligheder (inkl. iNaturalist AI-kamera, Standardkamera, Upload fra Galleri og Lydoptager)
All-observations = Alle observationer
All-observations-submitted-to-iNaturalist-need-a-date-and-location = Alle observationer indsendt til iNaturalist behøver en dato og placering for at være nyttige for forskere. Opdatér observationer, hvis de behøver mere information.
...
apple-full-name = { JOIN($namePrefix, $givenName, $middleName, $familyName, $nickname, $nameSuffix, separator: " ") }
...
Closes-explanation = Lukker forklaringen
Closes-introduction = Lukker introduktionen
Closes-new-observation-explanation = Lukker ny observationsforklaring.
...
Community-Discussion = Fællesskabsdiskussioner
Community-Guidelines = Fællesskabsretningslinjer
COMMUNITY-GUIDELINES = FÆLLESSKABSRETNINGSLINJER
Confidence--label = Tillid
CONFIRM = BEKRÆFT
Congrats-on-making-your-first-observation = Tillykke med den første observation!
...
Date-uploaded-on-header-short = Uploadet pr.:
...
Delete-current-observation = Slet aktuel observation
...
Disable-location = Deaktivér placering
...
DISMISS = AFVIS
Do-you-know-what-group-this-is-in = Ved man, hvilken gruppe dette er?
DONATE = DONÉR
DONATE-TO-INATURALIST = DONERE TIL INATURALIST
DONE = FÆRDIG
Dont-have-an-account = <0>Har ikke en konto?</0> <1>Opret konto.</1>
...
Enable-location = Aktivér placering
...
Get-identifications-from-real-people = Få identifikationer fra rigtige mennesker.
...
Getting-an-even-more-accurate-ID = Henter en endnu mere præcis ID...
Go-back = Gå tilbage
Google-Play-Services-Not-Installed = Google Play-tjenester ikke installeret
...
Grow-your-collection = Udvid samlingen
HELP = HJÆLP
Hide = Skjul
Highest = Højeste
HIGHEST-RANK = HØJESTE RANGERING
How-does-it-feel-to-identify = Hvordan føles det at identificere og forbinde til naturen omkring sig?
I-agree-to-the-Terms-of-Use = <0>Jeg accepterer Vilkår for brug samt Fortrolighedspolitik, og jeg har modtaget Fællesskabsretningslinjer (</0><1>obligatorisk</1><0>).</0>
Iconic-taxon-name = Ikonisk taksonnavn: { $iconicTaxon }
ID-Suggestions = ID-forslag
...
If-you-took-the-original-photo-you-can-help = Har man taget det oprindelige foto af organismen, kan man hjælpe med at uddanne iNaturalist i at identificere denne art ved at gemme og uploade den til iNaturalist, hvor fællesskabet kan hjælpe med at identificere den.
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist kan gemme fotos taget i appen i enhedens Galleri.
INATURALIST-COMMUNITY = INATURALIST-FÆLLESSKAB
iNaturalist-couldnt-identify-this-organism = iNaturalist kunne ikke identificere denne organisme.
...
INATURALIST-MODE = INATURALIST-TILSTAND
...
iNaturalists-apps-are-designed-and-developed-3 = iNaturalist-apps er designet, udviklet og understøttet af iNaturalist-teamet: Yaron Budowski, Amanda Bullington, Tony Iwane, Johannes Klein, Patrick Leary, Joanne Lin, Scott Loarie, Abhas Misraraj, Sylvain Morin, Carrie Seltzer, Alex Shepard, Thea Skaff, Angie Ta, Ken-ichi Ueda, Kirk van Gorkom, Jason Walthall og Jane Weeden.
...
It-can-now-be-shared-for-use-in-research = Den kan nu deles til brug inden for forskning
It-may-take-up-to-an-hour-to-remove-content = En fuldstændig sletning af alt tilknyttet indhold kan tage op til en time
It-might-also-be = Det kan også være
January = Januar
JOIN = TILMELD
...
Learn-More = Lær mere
LEARN-MORE-ABOUT-THIS-GROUP = LÆS MERE OM DENNE GRUPPE
LEARN-MORE-ABOUT-THIS-SPECIES = LÆS MERE OM DENNE ART
LEAVE = FORLAD
...
My-Observations = Egne observationer
My-Observations--bottom-tab = Mig
...
Navigates-to-match-screen = Navigerer til match af skærm
...
Notifications--bottom-tab = Aktivitet
...
notifications-user1-added-comment-to-observation-by-user2 = <0>{ $user1 }</0> føjede en kommentar til en observation fra { $user2 }
notifications-user1-added-identification-to-observation-by-user2 = <0>{ $user1 }</0> føjede en identifikation til en observation fra { $user2 }
November = November
...
Observation-Copyright = Observationsophavsret: © { $userName } · { $restrictions }
...
OBSERVED-AT--label = OBSERVATIONSTIDSPUNKT
OBSERVED-IN--label = OBSERVET I/PÅ
Observers = Observatører
Observers-View = Observatørvisning
October = Oktober
Offensive-Inappropriate = Stødende/upassende
Offensive-Inappropriate-Examples = Vildledende eller ulovligt indhold, racistisk/etnisk nedgørelse mv. Mere om vores definition af “passende” kan man finder i FAQ'en.
Offline-DQA-description = DQA er muligvis ikke præcis. Tjek internetforbindelsen, og forsøg igen.
Offline-suggestions-may-differ-from-online = Offline-forslag kan afvige fra online-forslag, og taksonbilleder samt almindelige navne indlæses muligvis ikke.
OK = OK
...
Once-youve-uploaded-to-iNaturalist = Når man har uploadet til iNaturalist, kan andre naturalister i fællesskabet hjælpe med at bekræfte identifikationerne. Hold øje med notifikationer for opdateringer!
Open = Åben
...
Other-members-of-our-community-can-verify = Andre medlemmer af fællesskabet kan bekræfte og identificere de observationer, man uploader til iNaturalist.
...
Pull-to-refresh-and-sync-observations = Træk for at opfriske og synke observationer
Pull-to-refresh-notifications = Træk for at opfriske notifikationer
...
Research-Grade-Status = Forskningskvalitetsstatus
...
Save = Gem
SAVE-ALL = GEM ALLE
Save-all-observations = Gem alle observationer
SAVE-CHANGES = GEM ÆNDRINGER
SAVE-FOR-LATER = GEM TIL SENERE
SAVE-LOCATION = GEM PLACERING
SAVE-PHOTOS = GEM FOTOS
Save-photos-to-your-photo-library = Gem fotos i Galleri
...
Scientists-use-citizen-science-data = Forskere bruger borgervidenskabelige data som hjælp til bedre at forstå arter kloden over.
SEARCH = SØG
Search = Søg
...
Sign-in-with-Apple = Log ind med Apple
Sign-in-with-Apple-Failed = Indlogning med Apple mislykkedes
Sign-in-with-Google = Log ind med Google
Sign-in-with-Google-Failed = Indlogning med Google mislykkedes
Skip-additional-suggestions = Overspring yderligere forslag
Skip-for-now = Overspring for nu
...
That-email-is-already-associated-with-an-account = Denne e-mail er allerede tilknyttet en konto.
That-user-profile-doesnt-exist = Denne brugerprofil findes ikke
That-username-is-unavailable = Dette brugernavn er utilgængeligt
...
This-may-take-a-few-seconds = Dette kan tage nogle sekunder.
This-observation-has-no-comments-or-identifications-yet = Denne observation har endnu ingen kommentarer eller identifikationer.
This-observation-has-not-met-the-conditions-required-to-meet-Research-Grade = Denne observation har ikke opfyldt betingelserne for status som Forskningskvalitet.
This-observation-is-not-eligible-for-research-grade-status = Denne observation er ikke berettiget til forskningskvalitetsstatus. Få mere at vide i Datakvalitetsvurdering nedenfor.
This-observation-is-research-grade-and-can-be-used-by-scientists = Denne observation er af forskningskvalitet og kan bruges af videnskabsfolk!
This-observation-needs-more-identifications = Denne observation behøver flere identifikationer for at nå Forskningskvalitet
...
Upload-photos-from-your-photo-library = Upload flere fotos fra Galleri
...
Use-iNaturalist-to-collect-any-kind-of = Brug iNaturalist til at indsamle enhver form for plante, insekt, edderkop, fugl eller andet dyr og føje dem til sine observationer!
Use-iNaturalist-to-identify-any-living-thing = Brug iNaturalist til at identificere alle levende ting
...
Users = Brugere
Using-location = Bruger placering
...
Watch-your-notifications-for-identifications = Se notifikationerne for identifikationer!
...
Weve-made-some-updates = Vi har lavet nogle opdateringer, så vi anbefaler, at man tager et kig på sine indstillinger. Disse kan altid opdateres senere.
...
X-percent = { $count }%
X-percent-confidence = { $count }% tillid
X-PHOTOS =
    { $photoCount ->
        [one] 1 FOTO
...
You-likely-observed-a-new-species = Man har sandsynligvis observeret en ny art!
You-likely-observed-a-species = Man har sandsynligvis observeret en art
You-likely-observed-an-organism-in-this-group = Man har sandsynligvis observeret en organisme i denne gruppe
You-make-an-observation-every-time-you = Man foretager en observation, hver gang man tager et foto af en organisme med en dato og placering.
You-may-have-observed-a-new-species = Man har muligvis observeret en ny art!
You-may-have-observed-a-species = Man har muligvis observeret en art
You-may-have-observed-an-organism-in-this-group = Man har muligvis observeret en organisme i denne gruppe
...
You-observed-a-new-species = En ny art er blevet observerede!
You-observed-a-species = Man observerede en art
You-observed-an-organism-in-this-group = Man observerede en organisme i denne gruppe
...
Your-observations-can-help-scientists = Observationerne kan hjælpe forskere!
Your-observations-can-now-help-scientists = Observationerne kan nu hjælpe forskere!
...
Youve-made-2-observations = Man har foretaget 2 observationer!
