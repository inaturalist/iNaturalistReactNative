...
Could-not-complete-at-this-time = Toimintoa ei voitu suorittaa tällä kertaa.
Could-not-complete-at-this-time-description = Yritä vapauttaa laitteen muistia tai käynnistää sovellus uudelleen ja yritä uudelleen.
...
No-space-left-on-device = Laitteessa ei ole riittävästi tilaa.
No-space-left-on-device-try-again = Laitteessa ei ole tarpeeksi muistia. Tyhjennä muistia ja yritä uudelleen.
none = ei mitään
