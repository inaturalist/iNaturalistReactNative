...
ABOUT = Acerca de
ABOUT-COLLECTION-PROJECTS = ACERCA DE PROYECTOS DE RECOPILACIÓN
ABOUT-INATURALIST = ACERCA DE INATURALIST
ABOUT-THE-DQA = ACERCA DE LA DQA
...
ABOUT-TRADITIONAL-PROJECTS = ACERCA DE PROYECTOS TRADICIONALES
ABOUT-UMBRELLA-PROJECTS = ACERCA DE LOS PROYECTOS PRINCIPALES
...
ADD-AN-ID = AÑADIR UN ID
Add-an-ID-Later = Añadir un ID más tarde
...
ADD-LOCATION-FOR-BETTER-IDS = AÑADIR UBICACIÓN PARA MEJORES ID
Add-location-to-refresh-suggestions = Agrega una ubicación para actualizar las sugerencias
Add-observations = Agrega observaciones
...
Adds-ID = Añadir ID
Adds-your-vote-of-agreement = Añadir tu voto de acuerdo
Adds-your-vote-of-disagreement = Añadir tu voto de desacuerdo
...
Agree = De acuerdo
AGREE = DE ACUERDO
AGREE-WITH-ID = ¿ESTÁS DE ACUERDO CON EL ID?
Agree-with-ID-description = ¿Está de acuerdo con el ID y sugiere las siguientes identificaciones?
AI-Camera = Cámara IA
ALL = TODOS
All = Todo
All-observation-options--list = Todas las opciones de observaciones: Cámara IA de iNaturalist, la Cámara estándar, Carga desde la Galería de Fotos y la Grabadora de Sonidos
All-observations = Todas las observaciones
All-observations-need-a-date-and-location-to-be-used-for-science = Todas las observaciones necesitan una fecha y una ubicación para ser utilizadas por la ciencia. Por favor, edita tus  observaciones en caso de necesitar más información.
...
Already-have-an-iNaturalist-account = ¿Ya tienes una cuenta de iNaturalist?
Amphibians = Amphibians
An-Internet-connection-is-required = Se necesita una conexión a internet para cargar más observaciones.
Analyzing-for-the-best-identification = Analizando para una mejor identificación...
Any--date = Cualquier
...
Any--user = Cualquier
Anyone-using-iNaturalist-can-see = Cualquiera que utilice iNaturalist puede ver dónde se observó está especie, y los científicos pueden usarlo fácilmente para su investigación.
...
April = abril
Arachnids = Arachnids
Are-you-an-educator = ¿Eres un profesor que quiere usar iNaturalist con tus estudiantes?
Are-you-sure-you-want-to-log-out = ¿Estas seguro de que quieres salir de tu cuenta de iNaturalist? Todas las observaciones que no se hayan subido a iNaturalist serán eliminadas.
...
attribution-cc-by-nd = algunos derechos reservadors (CC BY-ND)
attribution-cc-by-sa = algunos derechos reservados (CC BY-SA)
August = agosto
BACK-TO-LOGIN = VOLVER AL INICIO DE SESIÓN
Birds = Birds
BLOG = BLOG
Bulk-importer = Importación masiva
By-exiting-changes-not-saved = Al salir, los cambios en tu observación no serán guardados.
By-exiting-observation-not-saved = Al salir, tu observación no será guardada.
By-exiting-your-observations-not-saved = Al salir, tus observaciones no serán guardadas. Puedes guardarlas en tu dispositivo o puedes eliminarlas.
By-exiting-your-photos-will-not-be-saved = Al salir, tus fotos no serán guardadas.
By-exiting-your-recorded-sound-will-not-be-saved = Al salir, tu grabación no será guardada.
BY-ME = POR MI
By-uploading-your-observation-to-iNaturalist-you-can = Al subir tu observación a iNaturalist, puedes:
Camera = Cámara
CANCEL = CANCELAR
Cancel = Cancelar
Captive-Cultivated = En Cautiverio/Cultivado
...
Change-date = Cambiar fecha
CHANGE-END-DATE = CAMBIAR FECHA DE FINALIZACIÓN
Change-end-date = Cambiar fecha de finalización
Change-observations-sort-order = Cambiar el orden de las observaciónes
Change-project = Cambiar proyecto
Change-species-sort-order = Cambiar el orden de clasificación de especies
CHANGE-START-DATE = CAMBIAR FECHA DE INICIO
Change-start-date = Cambiar fecha de inicio
Change-taxon = Cambiar de taxón
...
Closes-withdraw-id-sheet = Cerrar la hoja "Withdraw ID"
...
Combine-Photos = Cimbinar Fotos
COMMENT = COMENTARIOS
Comment-options = Opciones de Comentarios
Common-Name-Scientific-Name = Nombre Común (Nombre Científico)
Community-Discussion = Debate de la Comunidad
Community-Guidelines = Directrices de la comunidad
COMMUNITY-GUIDELINES = LINEAMIENTOS DE LA COMUNIDAD
Confidence--label = Nivel de Confianza
CONFIRM = CONFIRMAR
Congratulations-You-made-your-first-observation = ¡Felicidades! ¡Hiciste tu primera obseración!
Connect-with-expert-naturalists = Conectar con naturalistas expertos
Connect-with-other-naturalists = Conectar con otros naturalistas y participa en conversaciones.
Connection-problem-Please-try-again-later = Problema de conexión. Inténtalo de nuevo más tarde.
...
Couldnt-create-comment = No se pudo crear el comentario
Couldnt-create-identification-error = No se pudo crear una identificación { $error }
Couldnt-create-identification-unknown-error = No se pudo crear una identificación, error desconocido.
CREATE-AN-ACCOUNT = CREAR UNA CUENTA
Create-observation-with-no-evidence = Crear una observación sin evidencia
DATA-QUALITY = CALIDAD DE DATOS
DATA-QUALITY-ASSESSMENT = EVALUACIÓN DE CALIDAD DE DATOS
Data-Quality-Assessment = Evaluación de Calidad de Datos
Data-quality-assessment-can-taxon-still-be-confirmed-improved-based-on-the-evidence = Basándose en la evidencia, ¿se puede mejorar el Taxon de laComunidad?
Data-quality-assessment-community-taxon-species-level-or-lower = Taxón de la cominidad a nivel de especie o niveles inferiores
Data-quality-assessment-date-is-accurate = La fecha es correcta
Data-quality-assessment-date-specified = Fecha especificada
Data-quality-assessment-description-casual = Esta observación no ha cumplido con las condiciones para alcanzar el estatus de  Grado de Investigación
Data-quality-assessment-description-needs-id = Esta observación aún no ha cumplido con las condiciones para alcanzar el estatus de Grado de Investigación.
...
Data-quality-assessment-title-casual = Esta observación es de Grado Casual
Data-quality-assessment-title-needs-id = Esta observación necesita identificación
...
DATE-OBSERVED-NEWEST = FECHA DE OBSERVACIÓN - DE LA MÁS NUEVA A LA MÁS ANTIGUA
...
Opens-search-interface = Abre interfaz de búsqueda.
