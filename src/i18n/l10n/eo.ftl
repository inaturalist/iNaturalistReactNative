...
Close = Fermi
Community-Guidelines = Komunumaj Gvidnormoj
# Data Quality Assessment section label: whether or not the observation date is accurate
Data-quality-assessment-date-is-accurate = Dato estas ĝusta
# Data Quality Assessment metric
Data-quality-assessment-evidence-of-organism = Atesto de organismo
# Data Quality Assessment metric
Data-quality-assessment-has-photos-or-sounds = Havas Fotojn aŭ Sonojn
# Data Quality Assessment metric
Data-quality-assessment-location-is-accurate = Loko estas preciza
# label in project requirements
Date = Dato
Date-observed = Dato de observo
# Month of December
December = decembro
Delete-observation = Forigi observon
# Button label or accessibility label for an element that deletes a photo
Delete-photo = Forigi foton
DONATE = DONACU
# Button for editing something
Edit = Redakti
Edit-Observation = Redakti Observon
# Indicates a species only occurs in a specific place
Endemic = Endemia
Exact-Date = Ekzakta Dato
Explore = Esplori
# Month of February
February = februaro
Filter = Filtri
...
Projects = Projektoj
Ranks-Class = Klaso
Ranks-Complex = Komplekso
Ranks-Family = Familio
Ranks-Form = Formo
Ranks-Genus = Genro
Ranks-Genushybrid = Generhibrido
Ranks-Hybrid = Hibrido
Ranks-Infraclass = Infraklaso
Ranks-Infraorder = Infraordo
Ranks-Kingdom = Regno
Ranks-Order = Ordo
Ranks-Phylum = Filumo
Ranks-Section = Sekcio
Ranks-Species = Specio
Ranks-Subclass = Subklaso
Ranks-Subfamily = Subfamilio
Ranks-Subgenus = Subgenro
Ranks-Subkingdom = Subregno
Ranks-Suborder = Subordo
Ranks-Subphylum = Subfilumo
Ranks-Subsection = Subsekcio
Ranks-Subspecies = Subspecio
Ranks-Subtribe = Subtribo
Ranks-Superclass = Superklaso
Ranks-Superfamily = Superfamilio
Ranks-Superorder = Superordo
Ranks-Supertribe = Supertribo
Ranks-Tribe = Tribo
Ranks-Zoosection = Zoosekcio
Ranks-Zoosubsection = Zoosubsekcio
# Quality grade indicating observation is accurate and complete enough to
# share outside of iNat
Research-Grade--quality-grade = Esplora Grado
# Label for button that restores a withdrawn identification
Restore = Restarigi
# Label for the satellite map type
Satellite--map-type = Satelito
