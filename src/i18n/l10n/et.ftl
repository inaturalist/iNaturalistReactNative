...
Advanced--interface-mode-with-explainer = Rohkem (Lae korraga mitu pilti ja heli)
...
iNaturalist-couldnt-identify-this-organism = iNaturalist ei suutnud seda organismi määratleda.
