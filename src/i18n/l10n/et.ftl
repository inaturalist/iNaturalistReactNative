...
Data-quality-casual-description = See vaatlus vajab rohkem infot, et seda saaks pidada tõendatuks.
Data-quality-needs-id-description = See vaatlus vajab rohkem määratlusi, et see oleks teaduskõlbulik
Data-quality-research-description = Sel vaatlusel on piisavalt määratlusi, et seda peetaks teaduskõlbulikuks
DATE = KUUPÄEV
Date = Kuupäev
...
MY-OBSERVATIONS--notifications = MINU VAATLUSED
Native = Kohalik
...
OTHER-OBSERVATIONS--notifications = TEISTE VAATLUSED
