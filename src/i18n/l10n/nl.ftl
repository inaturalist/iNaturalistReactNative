...
ALL = ALLES
All = Alle
All-observation-options = Alle waarnemingsopties (inclusief iNaturalist AI Camera, Standard Camera, Uploaden van de galerij en Sound Recorder)
All-observations = Alle waarnemingen
All-observations-submitted-to-iNaturalist-need-a-date-and-location = Alle waarnemingen die aan iNaturalist worden toegevoegd hebben een datum en locatie nodig om nuttig te zijn voor wetenschappers. Voeg deze informatie toe aan waarnemingen als dit ontbreekt.
...
CONFIRM = BEVESTIG
Congrats-on-making-your-first-observation = Gefeliciteerd met jouw eerste waarneming!
...
Get-identifications-from-real-people = Krijg determinaties van echte mensen.
...
Grow-your-collection = Maak je verzameling groter
HELP = HELP
Hide = Verbergen
Highest = Hoogste
HIGHEST-RANK = HOOGSTE RANG
How-does-it-feel-to-identify = Hoe voelt het om je te identificeren en verbinding te maken met de natuur om je heen?
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = iNaturalist kan foto's die je in de app neemt opslaan in de fotogalerij van je toestel.
INATURALIST-COMMUNITY = INATURALIST GEMEENSCHAP
iNaturalist-couldnt-identify-this-organism = iNaturalist kon dit organisme niet determineren.
...
Once-youve-uploaded-to-iNaturalist = Zodra je hebt geüpload naar iNaturalist kunnen andere naturalisten in onze gemeenschap je helpen met determinaties. Houd je meldingen in de gaten!
Open = Open
...
Other-members-of-our-community-can-verify = Andere leden van onze gemeenschap kunnen je waarnemingen verifiëren en determineren als je ze uploadt naar iNaturalist.
...
Save-photos-to-your-photo-library = Sla foto's op in je fotogalerij
...
Scientists-use-citizen-science-data = Wetenschappers gebruiken burgerwetenschappelijke gegevens zoals die van jou om soorten over de hele wereld beter te begrijpen.
SEARCH = ZOEK
Search = Zoeken
...
Use-iNaturalist-to-collect-any-kind-of = Gebruik iNaturalist om elk soort plant, insect, spin, vogel of ander dier te verzamelen en voeg ze toe aan jouw waarnemingen!
...
Weve-made-some-updates = We hebben enkele wijzigingen gemaakt, dus controleer opnieuw je instellingen. Je kunt deze later altijd bijwerken.
...
You-make-an-observation-every-time-you = Je maakt een waarneming elke keer als je een foto maakt van een organisme met een datum en locatie.
...
Your-observations-can-help-scientists = Jouw waarnemingen kunnen wetenschappers helpen!
Your-observations-can-now-help-scientists = Uw waarnemingen kunnen wetenschappers nu helpen.
...
Youve-made-2-observations = Je hebt 2 waarnemingen gemaakt!
