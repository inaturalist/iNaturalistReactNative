...
# before signing up
Agree-to-all-of-the-above = Ga akkoord met alle bovenstaande
...
ALL = ALLES
All = Alle
All-observation-option = Alle waarnemingsopties (inclusief iNaturalist AI Camera, Standard Camera, Uploaden van de galerij en Sound Recorder)
...
As-you-upload-more-observations = Als je meer waarnemingen uploadt, kunnen anderen je helpen om ze te determineren!
...
Check-this-box-if-you-want-to-apply-a-Creative-Commons = Vink dit selectievakje aan als jij een Creative Commons Naamsvermelding-NietCommerciële licentie wilt toepassen op geüploade inhoud. Dit betekent dat iedereen je foto's en waarnemingen kan kopiëren en hergebruiken zonder toestemming te vragen zolang ze je naam vermelden en het werk niet commercieel gebruiken. Je kunt een andere licentie kiezen of de licentie later verwijderen maar deze licentie is de beste licentie voor het delen met onderzoekers.
...
Create-an-observation-evidence = Creëer een waarneming zonder bewijs
...
Data-quality-casual-description = Deze waarneming heeft meer informatie nodig die geverifieerd kan worden om als Verifieerbaar te worden beschouwd
Data-quality-needs-id-description = Deze waarneming heeft meer determinaties nodig om Onderzoekskwaliteit te bereiken
Data-quality-research-description = Deze waarneming heeft genoeg determinaties om als Onderzoekskwaliteit te worden beschouwd
DATE = DATUM
...
DONE = KLAAR
Dont-have-an-account = Heb je nog geen account? Meld je aan
...
Obscured-observation-location-map-description = De locatie van deze waarneming is vervaagd. Je ziet een willekeurig punt binnen de vervagingsveelhoek.
...
Observations-you-upload-to-iNaturalist = Waarnemingen die je uploadt naar iNaturalist kunnen wereldwijd worden gebruikt door wetenschappers en onderzoekers.
...
Please-Allow-Gallery-Access = Sta galerij toegang toe
...
Please-click-the-link = Klik op de link in de e-mail binnen 60 minuten om je account te bevestigen
...
Record-organism-sounds-with-the-microphone = Neem geluiden van het organisme op met de microfoon
...
TERMS-OF-USE = GEBRUIKSVOORWAARDEN
Text-Box-to-Describe-Reason-for-Flag = Tekstvak om reden voor melding te beschrijven.
...
Upload-photos-from-your-gallery = Upload meerdere foto's uit je galerij
Upload-photos-from-your-gallery-and-create-observations = Upload foto's van je galerij en maak waarnemingen en krijg determinaties van organismen die je al hebt waargenomen!
...
# label in project requirements
Users = Gebruikers
Using-iNaturalist-requires-the-storage = Het gebruik van iNaturalist vereist de opslag van persoonlijke informatie zoals jouw e-mailadres, alle iNaturalist gegevens worden opgeslagen in de Verenigde Staten en we kunnen niet zeker zijn in welke juridische jurisdictie je zit wanneer je iNaturalist gebruikt, dus om te voldoen aan privacywetgeving zoals de AVG moet je erkennen dat je dit risico begrijpt en accepteert en ermee akkoord gaat dat jouw persoonlijke gegevens worden overgebracht naar de servers van iNaturalist in de VS.
...
We-sent-a-confirmation-email = We hebben een bevestigingsmail gestuurd naar het e-mailadres waarmee je je hebt aangemeld.
We-store-personal-information = Wij slaan persoonlijke informatie zoals gebruikersnamen en e-mailadressen op om accounts te beheren. Om te voldoen aan de privacywetgeving moet jij dit selectievakje aanvinken om aan te geven dat je akkoord gaat met dit gebruik jouw persoonlijke gegevens. Voor meer informatie over welke informatie we verzamelen en hoe we deze gebruiken, zie ons Privacybeleid en onze Gebruiksvoorwaarden.
Welcome-to-iNaturalist = Welkom bij iNaturalist!
...
Yes-license-my-photos = Ja, licentieer mijn foto's, geluiden en waarnemingen, zodat wetenschappers mijn gegevens kunnen gebruiken (aanbevolen).
...
You-can-also-explore-existing-observations = Je kunt ook bestaande waarnemingen op iNaturalist verkennen om te ontdekken wat er in je buurt gezien is.
...
You-can-search-observations-of-any-plant-or-animal = Je kunt waarnemingen doorzoeken van om het even welke plant of dier waar ook ter wereld met Verkenning!
...
Youre-always-in-control-of-the-location-privacy = Je hebt altijd de controle over de locatieprivacy van elke waarneming die u aanmaakt.
...
Youve-previously-denied-gallery-permissions = Je hebt eerder toestemming geweigerd voor de galerij, dus schakel ze in in de instellingen.
