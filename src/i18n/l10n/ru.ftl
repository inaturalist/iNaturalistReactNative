...
ID-WITH-AI = Идентифицировать с помощью  ИИ́
...
There-was-an-error-that-might-be-fixed-by-logging-in-again = Произошла ошибка, которая может быть исправлена путем повторного входа.
