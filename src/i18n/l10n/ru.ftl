...
Closes-new-observation-options = Закрывает новые параметры наблюдения.
...
Create-an-observation-evidence = Создайте наблюдение без доказательств
...
Flag-Item-Description = Пометка привлекает внимание волонтеров-кураторов сайта. Пожалуйста, не отмечайте проблемы, которые вы можете решить с помощью идентификации, оценки качества данных или поговорив с человеком, создавшим контент.
...
Identify-an-organism = Идентификация организма
...
If-you-hold-down-instead-of-tapping-the-camera-button-you-can = Если вы удерживаете кнопку (вместо нажатия), вы можете записывать звуки, делать несколько фото и импортировать из вашей галереи.
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-library = iNaturalist может сохранять фотографии, сделанные в приложении, в галерее вашего устройства.
...
More-ways-to-observe = Другие способы наблюдения
...
Navigates-to-match-screen = Уточним навигацию, чтобы карта на экране ей соответствовала
...
No-Notifications-Found = У вас нет уведомлений! Начните с создания собственных наблюдений.
...
Opens-the-side-drawer-menu = Открывает меню бокового ящика.
...
SAVE-PHOTOS = СОХРАНЯЙТЕ ФОТОГРАФИИ
Save-photos-to-your-library = Сохраняйте фото в своей галерее
...
Shows-iNaturalist-bird-logo = Показывает логотип птицы iNaturalist.
...
Skip-additional-suggestions = Пропустим дополнительные предложения
