...
A-global-community-for-nature = Természetjárók globális közössége
ABOUT = RÓLA
...
ALL = MIND
All = Mind
All-observation-options--list = Az összes megfigyelési lehetőség: MI-kamera, standard kamera, fényképek feltöltése könyvárból, hangrögzítés
...
Already-have-an-iNaturalist-account = Már van iNaturalist-fiókod?
An-Internet-connection-is-required = An Internet connection is required to load more observations.
Analyzing-for-the-best-identification = Elemzés a legpontosabb azonosításhoz...
Any--date = Any
...
Change-end-date = Change end date
Change-observations-sort-order = A megfigyelések sorrendjének módosítása
Change-project = Change project
Change-species-sort-order = A fajok sorrendjének módosítása
...
Connect-with-expert-naturalists = Ismerkedj természettudósokkal
...
Create-observation-with-no-evidence = Megfigyelés létrehozása bizonyíték nélkül
DATA-QUALITY = DATA QUALITY
DATA-QUALITY-ASSESSMENT = DATA QUALITY ASSESSMENT
Data-Quality-Assessment = Adatminőségi kiértékelés
...
Date-uploaded-on-header-short = Feltöltve:
...
datetime-format-short = yyyy.M.d H:mm
...
DISCOVER-NATURE-AROUND-YOU = ISMERD MEG A KÖRNYEZETED
DISMISS = DISMISS
...
Experts-help-verify-and-improve-IDs = Szakértői azonosítás
Explore = Felfedezés
EXPLORE = EXPLORE
...
Get-an-instant-ID-of-any-plant-animal-fungus = Azonnali meghatározás bármely növényre, állatra és gombára
...
Go-back = Vissza
Google-Play-Services-Not-Installed = Google Play Services nincs telepítve
...
Help-protect-species = Segítsd a fajok védelmét
Hide = Elrejtés
Highest = Highest
...
ID-in-Camera = Azonosítás a fényképezővel
...
IDENTIFY = AZONOSÍTÁS
Identify-organisms-in-real-time-with-your-camera = Valósidejű meghatározás a kameráddal
...
If-you-leave-x-of-your-observations-removed =
    Ha kilépsz ebből a hagyományos projektből, { $count ->
       ...
       *[other] { $count } megfigyelésed
    } szintén eltávolításra kerül abból.
If-you-save-this-observation-and-upload-it-to-iNaturalist = Ha feltöltöd ezt a megfigyelést az iNaturalistra, a többi felhasználó segíteni fog az azonosításban.
...
Improve-suggestions-by-using-your-location = A helyzeted megosztásával javíthatod a javaslatokat
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-library = Az iNaturalist az applikációval készített képeket el tudja menteni a mobilod fényképei közé.
...
It-might-be-one-of-these = Talán az alábbiak egyike
January = Január
JOIN = CSATLAKOZÁS
Join-a-global-community-for-nature = Csatlakozz a természetjárók globális közösségéhez
...
Least-Observed = Legkevesebb megfigyelés
LEAVE = LEAVE
...
Most-faved = Most faved
Most-Observed-Default = Legtöbb megfigyelés (alapértelmezett)
MY-CONTENT--notifications = TARTALMAIM
My-Observations = Megfigyeléseim
My-Observations--bottom-tab = Saját
Native = Őshonos
...
Notifications--bottom-tab = Aktivitás
...
Observation-Copyright = Megfigyelés Copyright: © { $userName } · { $restrictions }
Observation-has-no-photos-and-no-sounds = This observation has no photos and no sounds.
Observation-location-obscured-randomized-point = E megfigyelés földrajzi helye ki van takarva. Amit látsz, az egy random hely a pontos hely köré rajzolt területen belül.
...
Or-you-can-try-to-get-a-clearer-photo-by-zooming-in-getting-closer = Esetleg jobb, közeli képet készíthetsz ráközelítéssel vagy más szögből.
...
Point-the-camera-at-an-animal-plant-or-fungus = Irányítsd a kamerát egy állatra, növényre vagy gombára
...
Press-and-hold-to-view-more-options = A többi opcióhoz tartsd lenyomva
...
Save-photos-to-your-library = Fényképek mentése a könyvtáradba
...
Sign-in-with-Apple-Failed = Sikertelen bejelentkezés Apple-fiókkal
Sign-in-with-Google = Bejelentkezés Google-fiókkal
Sign-in-with-Google-Failed = Sikertelen bejelentkezés Google-fiókkal
...
SORT-BY = SORT BY
Sort-by = Sort by
SORT-SPECIES = FAJOK RANGSOROLÁSA
...
Species-with-the-least-observations-appear-first = A legkevesebb megfigyeléssel rendelkező fajok jelennek meg elsőként
Species-with-the-most-observations-appear-first = A legtöbb megfigyeléssel rendelkező fajok jelennek meg elsőként
...
The-AI-is-not-confident-It-may-be-one-of-the-IDs-below = Nincs kellő bizonyosságú javaslat. Talán valamelyik az alábbiak közül.
The-AI-is-not-confident-Upload-to-ask-the-community = Nincs kellő bizonyosságú javaslat. Töltsd fel a közösségi meghatározáshoz.
...
There-was-an-error-that-might-be-fixed-by-logging-in-again = Hiba történt. Újra bejelentkezve talán megoldódik.
...
This-user-has-no-followers = Nincsenek követői.
This-user-has-not-joined-any-projects = Nem csatlakozott projektekhez.
This-user-is-not-following-anyone = Nem követ senkit.
...
Upload-photos = Fényképek feltöltése
...
Use-the-iNaturalist-camera-to-see-real-time-identifications-and-take-photos = Az iNaturalist-kamerával valósidőben határozhatsz meg fajokat és fényképeket is készíthetsz.
Use-your-devices-microphone-to-record-animal-sounds-and-share-them = A mobilod mikrofona segítségével állathangokat rögzíthetsz, amelyek segítenek az azonosításban, és hasznosak a kutatások számára.
USER = USER
User = User { $userHandle }
USERNAME-OR-EMAIL = USERNAME OR EMAIL
Users = Felhasználók
Using-location = Using location
Verified-IDs-are-used-for-science-and-conservation = A megerősített meghatározásat a kutatók és a természetvédők felhasználják
...
You-likely-observed-a-species-in-this-group = Valószínűleg van már megfigyelt fajod ebben a csoportban
You-likely-observed-this-species = Valószínűleg már megfigyelted ezt a fajt
You-may-have-observed-a-species-in-this-group = Elképzelhető, hogy van már megfigyelt fajod ebben a csoportban
You-may-have-observed-this-species = Elképzelhető, hogy már megfigyelted ezt a fajt
...
You-observed-a-species-in-this-group = Már van megfigyelt fajod ebben a csoportban
You-observed-this-species = Már megfigyelted ezt a fajt
