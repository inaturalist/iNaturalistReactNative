...
FOLLOW = FOLLOW
FOLLOWING--notifications = KÖVETVE
FOLLOWING-X-PEOPLE =
    { $count ->
...
Offensive-Inappropriate-Examples = Félrevezető vagy illegális tartalom, rasszista vagy kiközösítő megnyilvánulás, stb. További információ a Gyakran Ismételt Kérdések között.
...
Upload-photos-from-your-photo-library = Több fénykép feltöltése a fényképkönyvtáradból
