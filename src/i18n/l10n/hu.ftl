...
ALL = MIND
All = Mind
All-observation-options = Minden megfigyelési opció (iNaturalist MI-Kamera, Standard Kamera, fényképfeltöltés könyvtárból, Hangrögzítő)
...
December = December
Default--interface-mode = Alapértelmezett
DELETE = DELETE
...
iNaturalist-can-save-photos-you-take-in-the-app-to-your-devices-photo-library = Az iNaturalist az alkalmazással készített fényképeket el tudja menteni a készülék fényképkönyvtárába.
...
Save-photos-to-your-photo-library = Fényképek mentése a fényképkönyvtáradba
