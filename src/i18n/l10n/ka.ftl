...
Data-quality-assessment-location-is-accurate = მდებარეობა ზუსტია
# Data Quality Assessment metric
Data-quality-assessment-location-specified = მდებარეობა მითითებულია
...
Needs-ID--quality-grade = ID სჭირდება
...
# or photo
View-suggestions = ვარაუდების ნახვა
