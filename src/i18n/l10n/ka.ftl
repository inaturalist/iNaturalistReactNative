...
attribution-cc-by-nc-sa = ზოგიერთი უფლება დაცულია (CC BY-NC-ND)
attribution-cc-by-nd = ზოგიერთი უფლება დაცულია (CC BY-NC)
attribution-cc-by-sa = ზოგიერთი უფლება დაცულია (CC BY-NC)
August = აგვისტო
...
Location = ადგილმდებარეობა
Location-accuracy-is-too-imprecise = ადგილმდებარეობის სიზუსტე ზედმეტად არაზუსტია იმისათვის, რომ დაეხმაროს ამომცნობებს. გთხოვთ, გაადიდოთ.
