...
import useLocalObservationUuids from "sharedHooks/useLocalObservationUuids";
import {
  UPLOAD_PENDING,
...
const MyObservationsContainer = ( ) => {
  ...
  const observationUuids = useLocalObservationUuids();
  const totalResultsLocal = observationUuids.length;
