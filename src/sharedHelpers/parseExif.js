...
// Parses EXIF date time into a date object
export const parseExif = async ( photoUri: ?string ): Promise<any> => {
  try {
...
export const writeExifToFile = async ( photoUri: ?string, exif: ExifToWrite ): Promise<any> => {
...
export const readExifFromMultiplePhotos = async ( photoUris: Array<string> ): Promise<any> => {
  const unifiedExif = {};
