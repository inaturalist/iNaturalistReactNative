...
// TODO: this is probably against conventioins to make it in lower case
// but I (Johannes) don't want to have to add another object somewhere else
// to map them to the values the API accepts
